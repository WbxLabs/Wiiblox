...
namespace WBX {
	...
	private:
		...
		wbx::signals::connection selectedConnectionShim;

	public:
		HopperBin();

		wbx::remote_signal<void()> replicatedSelectedSignal;
		wbx::remote_signal<void(shared_ptr<Instance>)> selectedSignal;
		wbx::signal<void()> deselectedSignal;
