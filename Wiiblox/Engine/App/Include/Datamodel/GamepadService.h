...
namespace WBX
{
	...
	typedef boost::unordered_map<wbx::KeyCode, shared_ptr<wbx::InputObject> > Gamepad;
    ...
    private:
		...
		wbx::Timer<wbx::Time::Fast> repeatGuiSelectionTimer;
		wbx::Timer<wbx::Time::Fast> fastRepeatGuiSelectionTimer;
		...
		wbx::signals::scoped_connection inputEndedConnection;
		wbx::signals::scoped_connection inputChangedConnection;
		wbx::signals::scoped_connection cameraCframeUpdateConnection;
        
        shared_ptr<wbx::InputObject> createInputObjectForGamepadKeyCode(wbx::KeyCode keyCode, wbx::InputObject::UserInputType gamepadType);
