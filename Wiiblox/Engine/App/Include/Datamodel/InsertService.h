...
namespace WBX {
	...
	public:
		...
		wbx::remote_signal<void(std::string, ContentId)> insertRequestSignal;
		wbx::remote_signal<void(std::string, int, int)> insertRequestAssetSignal;
		wbx::remote_signal<void(std::string, int, int)> insertRequestAssetVersionSignal;
		wbx::remote_signal<void(std::string, shared_ptr<Instance>)> insertReadySignal;
		wbx::remote_signal<void(std::string, std::string)> insertErrorSignal;
        wbx::remote_signal<void(shared_ptr<Instance>)> internalDeleteSignal;
    ...
    private:
		...
		wbx::signals::connection backendInsertConnection;
		wbx::signals::connection backendInsertAssetConnection;
		wbx::signals::connection backendInsertAssetVersionConnection;
        wbx::signals::scoped_connection backendInternalDeleteConnection;
		...
		wbx::signals::connection frontendInsertReadyConnection;
		wbx::signals::connection frontendInsertErrorConnection;
		...
		wbx::atomic<int> loadCount;	// used to uniquely identify a load asset request
