...
namespace WBX {
	...
	public:
        ...
        wbx::signal<void(shared_ptr<Instance>)> equippedToolSignal;
        wbx::signal<void(shared_ptr<Instance>)> unequippedToolSignal;
        
        wbx::signal<void(std::string, std::string, shared_ptr<const Reflection::ValueTable>)>  boundActionChangedSignal;
        wbx::signal<void(std::string, bool, shared_ptr<const Reflection::ValueTable>)> boundActionAddedSignal;
        wbx::signal<void(std::string, shared_ptr<const Reflection::ValueTable>)> boundActionRemovedSignal;
        
        wbx::signal<void(std::string)> getActionButtonSignal;
        wbx::signal<void(std::string, shared_ptr<Instance>)> actionButtonFoundSignal;
    ...
    protected:
        wbx::signals::scoped_connection characterChildAddConnection;
        wbx::signals::scoped_connection characterChildRemoveConnection;
        wbx::signals::scoped_connection localPlayerAddConnection;
	...
	private:
		...
		// these are used for Wiiblox context binds (For Wiiblox menu, etc.)
        ...
        void setupLocalPlayerConnections(wbx::Network::Player* localPlayer);
