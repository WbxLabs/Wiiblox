...
namespace WBX {
	...
	public:
		...
		//Should be private
		wbx::remote_signal<void(float,float,float, float)> internalPlaySignal;
		wbx::remote_signal<void(float,float)>		internalStopSignal;
		wbx::remote_signal<void(float,float,float)>	internalAdjustWeightSignal;
		wbx::remote_signal<void(float,float)>		internalAdjustSpeedSignal;
		wbx::remote_signal<void(std::string)>		keyframeReachedSignal;
		wbx::remote_signal<void()>					stoppedSignal;
