...
public:
	...
	wbx::signal<void()> moveSignal;
	wbx::signal<void()> idleSignal;
	wbx::signal<void()> button1DownSignal;
	wbx::signal<void()> button2DownSignal;
	wbx::signal<void()> button1UpSignal;
	wbx::signal<void()> button2UpSignal;
	wbx::signal<void()> wheelForwardSignal;
	wbx::signal<void()> wheelBackwardSignal;
	wbx::signal<void(std::string)> keyDownSignal;
	wbx::signal<void(std::string)> keyUpSignal;
	...
	virtual wbx::WBXRay getUnitRay() const;
