...
namespace WBX
{
	...
	class FlyweightService
		: public DescribedCreatable<FlyweightService, Instance, sFlyweightService, Reflection::ClassDescriptor::PERSISTENT, Security::Wiiblox>
		, public Service
	{
	protected:
		typedef DescribedCreatable<FlyweightService, Instance, sFlyweightService, Reflection::ClassDescriptor::PERSISTENT, Security::Wiiblox> Super;
		typedef boost::unordered_map<std::string, InstanceStringData> FlyweightInstanceMap;

		FlyweightInstanceMap instanceMap;

		wbx::signals::scoped_connection stringChildAddedSignal;
		wbx::signals::scoped_connection stringChildRemovedSignal;

		virtual void onChildAdded(shared_ptr<wbx::Instance> childInstance);
		...
		bool isChildData(shared_ptr<wbx::Instance> childData);
