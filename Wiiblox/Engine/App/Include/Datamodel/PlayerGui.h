...
namespace WBX {
	...
	public:
        ...
        GuiResponse processGesture(const UserInputService::Gesture gesture, shared_ptr<const wbx::Reflection::ValueArray> touchPositions, shared_ptr<const Reflection::Tuple> args);
	...
	protected:
        ...
        GuiResponse processGestureOnChild(GuiBase2d* guiBase, const UserInputService::Gesture gesture, shared_ptr<const wbx::Reflection::ValueArray> touchPositions, shared_ptr<const Reflection::Tuple> args);
	};
	...
	public:
        ...
        wbx::signal<void(float)> topbarTransparencyChangedSignal;
	...
	public:
		...
		wbx::signal<void(StarterGuiService::CoreGuiType,bool)> coreGuiChangedSignal;
	...
	public:
		...
		// used to add/remove standard lua gui elements in (for Wiiblox in-game gui) -bt
        ...
        shared_ptr<wbx::ScreenGui> getWiibloxScreenGui();
		...
		/*override*/ void setSelectionImageObject(GuiObject* value);
	private:
		shared_ptr<wbx::Instance> screenGui;

		wbx::Instances onScreenMessages;
	};
}
