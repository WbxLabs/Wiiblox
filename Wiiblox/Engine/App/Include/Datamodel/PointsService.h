...
namespace WBX
{
	...
	private:
		...
		wbx::signals::scoped_connection heartbeatSignalConnection;
		...
		static void startAwardPointsBatching(weak_ptr<wbx::DataModel> weakDm);
	...
	public:
		...
		wbx::remote_signal<void(int, int, int, int)> pointsAwardedSignal;
