...
namespace WBX {
	...
	protected:
		...
		wbx::signals::scoped_connection descentdantAdded;		
		wbx::signals::scoped_connection descentdantRemoved;				
		wbx::signals::scoped_connection ancestorChanged;
		wbx::signals::scoped_connection clumpChangedConnection;
	...
	public:
        ...
        wbx::remote_signal<void(ContentId, float, float, float)> onPlaySignal;
        wbx::remote_signal<void(ContentId, float)> onStopSignal;
		wbx::remote_signal<void(ContentId, float)> onAdjustSpeedSignal;
		wbx::remote_signal<void(ContentId, float)> onSetTimePositionSignal;
