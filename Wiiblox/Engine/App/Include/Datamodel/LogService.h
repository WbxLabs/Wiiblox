...
namespace WBX
{
    ...
    public:
        ...
        wbx::signal<void(std::string, MessageType)> outputMessageSignal;
        wbx::remote_signal<void(shared_ptr<Instance>)> requestServerOutputSignal;
        wbx::remote_signal<void(std::string, MessageType, int)> serverOutputMessageSignal;
		wbx::remote_signal<void(shared_ptr<Instance>, std::string)> requestScriptExecutionSignal;
    ...
    private:
        ...
        wbx::signals::scoped_connection messageOutConnection;
        boost::circular_buffer_space_optimized<StandardOutMessage> logHistory;
        wbx::signals::scoped_connection listenForServerLogRequestConnection;
