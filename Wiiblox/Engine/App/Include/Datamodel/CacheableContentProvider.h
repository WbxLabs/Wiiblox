...
namespace WBX {
	...
	class CacheableContentProvider
		: public DescribedNonCreatable<CacheableContentProvider, Instance, sCacheableContentProvider, wbx::Reflection::ClassDescriptor::RUNTIME_LOCAL>
		, public Service
		, public HeartbeatInstance
	{
		typedef DescribedNonCreatable<CacheableContentProvider, Instance, sCacheableContentProvider, wbx::Reflection::ClassDescriptor::RUNTIME_LOCAL> Super;
	...
	protected:
        ...
        wbx::atomic<int> pendingRequests;
		bool immediateMode;
