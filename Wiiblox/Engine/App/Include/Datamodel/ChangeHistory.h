...
private:
	...
	wbx::signals::scoped_connection itemAddedConnection;
	wbx::signals::scoped_connection itemRemovedConnection;
	wbx::signals::scoped_connection itemChangedConnection;
	wbx::signals::scoped_connection runTransitionConnection;
public:
    ...
    wbx::signal<void()> waypointChangedSignal;
    wbx::signal<void(std::string)> undoSignal;
    wbx::signal<void(std::string)> redoSignal;
...
private:
	...
	virtual void onItemAdded(shared_ptr<wbx::Instance> item);
	virtual void onItemRemoved(shared_ptr<wbx::Instance> item);
	virtual void onItemChanged(shared_ptr<wbx::Instance> item, const Reflection::PropertyDescriptor* descriptor);
	...
	void setRunWaypoint();
	void reportMissedPhysicsChanges(shared_ptr<wbx::Instance> instance);
};
