...
namespace WBX
{
	...
	public:
		...
		wbx::remote_signal<void()>	mouseEnterSignal;
		wbx::remote_signal<void()>	mouseLeaveSignal;
		wbx::remote_signal<void()>	mouseButton1DownSignal;
		wbx::remote_signal<void()>	mouseButton1UpSignal;
