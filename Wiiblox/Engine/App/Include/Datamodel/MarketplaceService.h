...
namespace WBX {
		...
		, public Service
	{
		...
		wbx::signals::scoped_connection playerRemovingConnection;
		...
		wbx::signals::scoped_connection playerAddedReceiptConnection;
		wbx::signals::scoped_connection playerPurchaseReceiptConnection;
		wbx::signals::scoped_connection verifyPurchaseConnection;
	...
	public:
        ...
        wbx::remote_signal<void(shared_ptr<Instance> player, std::string productId, bool isPurchased)> nativePurchaseFinished;
		wbx::remote_signal<void(shared_ptr<Instance> player, std::string productId)> promptNativePurchaseRequested;

		wbx::remote_signal<void(shared_ptr<Instance> player, std::string productId, std::string receipt, bool isPurchased)> thirdPartyPurchaseFinished;
		wbx::remote_signal<void(shared_ptr<Instance> player, std::string productId)> promptThirdPartyPurchaseRequested;

		wbx::remote_signal<void(shared_ptr<Instance> player, int assetId, bool equipIfPurchased, CurrencyType currencyType)> promptProductPurchaseRequested;
		wbx::remote_signal<void(int userId, int assetId, bool isPurchased)> promptProductPurchaseFinished;
				
		wbx::remote_signal<void(shared_ptr<Instance> player, int assetId, bool isPurchased)> promptPurchaseFinished;
		wbx::remote_signal<void(shared_ptr<Instance> player, int assetId, bool equipIfPurchased, CurrencyType currencyType)> promptPurchaseRequested;

		wbx::remote_signal<void(std::string response, int userId, int productId)> clientPurchaseSuccess;
		wbx::remote_signal<void(shared_ptr<const Reflection::ValueTable> responseTable)> serverPurchaseVerification;

        wbx::remote_signal<void(shared_ptr<const Reflection::Tuple>)> clientLuaDialogRequested;
		wbx::remote_signal<void(bool, shared_ptr<Instance>)> luaDialogCallbackSignal;
		...
		void onReceivedRawProductInfoSuccess(std::string urlPath, std::string response, boost::weak_ptr<wbx::DataModel> weakDM, boost::function<void(shared_ptr<const Reflection::ValueTable>)> resumeFunction, boost::function<void(std::string)> errorFunction);
		void onReceivedRawProductInfoError(std::string error, boost::weak_ptr<wbx::DataModel> weakDM, boost::function<void(std::string)> errorFunction);
