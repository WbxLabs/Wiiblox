...
namespace WBX
{
	...
	private:
        ...
        void fireGestureEvent(const UserInputService::Gesture& gesture, const shared_ptr<const wbx::Reflection::ValueArray>& touchPositions, const shared_ptr<const Reflection::Tuple>& args);
		...
		wbx::signals::scoped_connection draggingEndedConnection;
	...
	public:
		...
		void handleDrag(wbx::Vector2 mousePosition);
		void handleDragging(const shared_ptr<InputObject>& event);
		void handleDragBegin(wbx::Vector2 mousePosition);
		...
		// Selection Events
		wbx::signal<void()> selectionGainedEvent;
		wbx::signal<void()> selectionLostEvent;

		// low level generic event signals
		wbx::signal<void(shared_ptr<Instance>)> inputBeganEvent;
		wbx::signal<void(shared_ptr<Instance>)> inputChangedEvent;
		wbx::signal<void(shared_ptr<Instance>)> inputEndedEvent;
        
        // touch gesture event signals
        wbx::signal<void(shared_ptr<const wbx::Reflection::ValueArray>)> tapGestureEvent;
        wbx::signal<void(shared_ptr<const wbx::Reflection::ValueArray>,float, float, InputObject::UserInputState)> pinchGestureEvent;
        wbx::signal<void(UserInputService::SwipeDirection, int)> swipeGestureEvent;
        wbx::signal<void(shared_ptr<const wbx::Reflection::ValueArray>, InputObject::UserInputState)> longPressGestureEvent;
        wbx::signal<void(shared_ptr<const wbx::Reflection::ValueArray>, float, float, InputObject::UserInputState)> rotateGestureEvent;
        wbx::signal<void(shared_ptr<const wbx::Reflection::ValueArray>, Vector2, Vector2, InputObject::UserInputState)> panGestureEvent;

		wbx::remote_signal<void(int, int)>  mouseEnterSignal;
		wbx::remote_signal<void(int, int)>  mouseLeaveSignal;
		wbx::remote_signal<void(int, int)>	mouseMovedSignal;
		wbx::remote_signal<void(int, int)>	mouseWheelForwardSignal;
		wbx::remote_signal<void(int, int)>	mouseWheelBackwardSignal;
		...
		wbx::remote_signal<void(int, int)> dragStoppedSignal;
		wbx::remote_signal<void(UDim2)> dragBeginSignal;
        ...
        /*override*/ GuiResponse processGesture(const UserInputService::Gesture& gesture, const shared_ptr<const wbx::Reflection::ValueArray>& touchPositions, const shared_ptr<const Reflection::Tuple>& args);
	...
	public:
		...
		enum Style
		{
			CUSTOM_STYLE						= 0,
			Wiiblox_RED_STYLE					= 1,
			Wiiblox_GREY_STYLE					= 2,
			Wiiblox_BUTTON_ROUND_STYLE			= 3,
			Wiiblox_BUTTON_ROUND_DEFAULT_STYLE	= 4,
			Wiiblox_BUTTON_ROUND_DROPDOWN_STYLE	= 5,
		};

		static const Reflection::PropDescriptor<GuiButton, bool> prop_Modal;

		wbx::remote_signal<void()> mouseButton1ClickSignal;
        wbx::remote_signal<void()> mouseButton2ClickSignal;
		wbx::remote_signal<void(int, int)> mouseButton1DownSignal;
		wbx::remote_signal<void(int, int)>	mouseButton1UpSignal;
		wbx::remote_signal<void(int, int)>	mouseButton2DownSignal;
		wbx::remote_signal<void(int, int)>	mouseButton2UpSignal;
