...
namespace WBX {
	...
	public:
		...
		static std::string WiibloxVersion;
		static std::string WiibloxProductName;
		...
		std::string getWiibloxVersion() const { RBXASSERT(!WiibloxVersion.empty()); return WiibloxVersion; }
		std::string getWiibloxProductName() const { RBXASSERT(!WiibloxProductName.empty()); return WiibloxProductName; }
		...
		// perf counters
		int nameDatabaseSize() const { return (int) Name::size(); }
		int nameDatabaseBytes() const { return (int) Name::approximateMemoryUsage(); }
		...
		long getWiibloxSuccessCount() const;
		long getWiibloxFalureCount() const;
		double getWiibloxResponce() const;
