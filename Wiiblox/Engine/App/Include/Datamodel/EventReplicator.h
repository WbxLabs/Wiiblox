...
namespace WBX
{
	...
	protected:
		...
		wbx::signal<void()>& connectionSignal;
		
		wbx::signals::connection listenerConnection;
		void listenerConnectionAdded()
		{ 
			//wbx::StandardOut::singleton()->printf(wbx::MESSAGE_INFO, 
		...
		wbx::signals::connection signalConnection;
		virtual void connectSignalListener(){}
	public:
		EventReplicatorBase(wbx::signal<void()>& connectionSignal, 
						Reflection::RemoteEventDesc<Parent,Signature>& remoteEvent,
						Reflection::BoundProp<int>& connectionCount)
	...
	{
	public:
		EventReplicatorImpl(wbx::signal<void()>& connectionSignal, 
							Reflection::RemoteEventDesc<Parent,Signature>& remoteEvent,
							Reflection::BoundProp<int>& connectionCount)
	...
	{
	public:
		EventReplicator(wbx::signal<void()>& connectionSignal, 
						Reflection::RemoteEventDesc<Parent,Signature>& remoteEvent, 
						Reflection::BoundProp<int>& connectionCount)
...
#define DECLARE_EVENT_REPLICATOR_SIG(Parent,eventName,signature)\
	...
	wbx::EventReplicator<Parent,signature> CHELPER2(eventReplicator,eventName);

#define category_EventReplicator "EventReplicator"
#define IMPLEMENT_EVENT_REPLICATOR(Parent,eventDesc,eventText,eventName)\
	Reflection::BoundProp<int> Parent::CHELPER3(prop_,eventName,ConnectionCount)(eventText "ConnectionCount", category_EventReplicator, &Parent::CHELPER3(var,eventName,ConnectionCount), wbx::Reflection::PropertyDescriptor::REPLICATE_ONLY);
