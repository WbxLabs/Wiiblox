...
namespace WBX {
	...
	public:
		...
		shared_ptr<const wbx::Reflection::ValueTable> getFVariables();
	...
	class GlobalAdvancedSettingsItem
		 : public wbx::DescribedCreatable<Class, wbx::GlobalAdvancedSettings::Item, sClassName>
		 , public Service
	{
		typedef wbx::DescribedCreatable<Class, wbx::GlobalAdvancedSettings::Item, sClassName> Super;
	...
	protected:
		GlobalAdvancedSettingsItem()
		{
			...
			if (sing)
				throw wbx::runtime_error("singleton %s already exists", sClassName);
			sing = this;
		}
		~GlobalAdvancedSettingsItem()
		{
	...
	public:
		static Class& singleton()
		{
			...
			wbx::GlobalAdvancedSettings* gs = wbx::GlobalAdvancedSettings::singleton().get();
	...
	class GlobalBasicSettingsItem
		 : public wbx::DescribedCreatable<Class, wbx::GlobalBasicSettings::Item, sClassName>
		 , public Service
	{
		typedef wbx::DescribedCreatable<Class, wbx::GlobalBasicSettings::Item, sClassName> Super;
	...
	public:
		static Class& singleton()
		{
			...
			wbx::GlobalBasicSettings* gs = wbx::GlobalBasicSettings::singleton().get();
			boost::mutex::scoped_lock lock(gs->mutex);
			if (!sing)
			{
				// "s" won't get collected when we leave scope because the parent will hold a ref to it 
