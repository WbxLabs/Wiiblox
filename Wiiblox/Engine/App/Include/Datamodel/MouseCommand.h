...
namespace WBX {
	...
	public:
		static WBXRay getUnitMouseRay(const shared_ptr<InputObject>& inputObject, ICameraOwner* workspace);
		static WBXRay getSearchRay(const shared_ptr<InputObject>& inputObject, ICameraOwner* workspace);
		static WBXRay getSearchRay(const WBXRay& unitRay);
		Instance* getTopSelectable3d(PartInstance* part) const;

		WBXRay getUnitMouseRay(const shared_ptr<InputObject>& inputObject) const;
		WBXRay getSearchRay(const shared_ptr<InputObject>& inputObject) const;
