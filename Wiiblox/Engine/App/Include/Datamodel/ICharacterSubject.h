...
namespace WBX {
	...
	class WBXInterface ICharacterSubject : public CameraSubject
	{
	public:
		ICharacterSubject();
		...
		wbx::Camera::CameraMode getCameraMode() const { return cameraMode; };
		void setCameraMode (wbx::Camera::CameraMode value);
	...
	private:
		...
		wbx::Camera::CameraMode cameraMode;
