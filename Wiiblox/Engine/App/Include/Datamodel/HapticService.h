...
namespace WBX
{
	...
	private:
		...
		typedef boost::unordered_map<VibrationMotor, shared_ptr<const wbx::Reflection::Tuple> > VibrationStateMap;
	...
	public:
		...
		wbx::signal<void(InputObject::UserInputType, VibrationMotor, shared_ptr<const wbx::Reflection::Tuple>)> setVibrationMotorSignal;
		wbx::signal<void(InputObject::UserInputType)> setEnabledVibrationMotorsSignal;
		...
		void setMotor(InputObject::UserInputType inputType, HapticService::VibrationMotor vibrationMotor, shared_ptr<const wbx::Reflection::Tuple> args);
		shared_ptr<const wbx::Reflection::Tuple> getMotor(InputObject::UserInputType inputType, HapticService::VibrationMotor vibrationMotor);
	};
}