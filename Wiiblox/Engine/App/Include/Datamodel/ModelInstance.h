...
namespace WBX {
	...
	protected:
		...
		// PVInstance
		/*override*/ bool hitTestImpl(const class wbx::WBXRay& worldRay, G3D::Vector3& worldHitPoint);
	...
	public:
		...
		bool containedByFrustum(const class wbx::Frustum& frustrum) const;
		...
		float computeLargestMoment() const;		// kg*WBX^2
