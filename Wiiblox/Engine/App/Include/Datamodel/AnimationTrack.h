...
namespace WBX {
	...
	protected:
		...
		wbx::signals::connection keyframeReachedConnection;
		wbx::signals::connection stoppedConnection;
	...
	public:
		...
		wbx::signal<void(std::string)> keyframeReachedSignal;
		wbx::signal<void()> stoppedSignal;
	};
