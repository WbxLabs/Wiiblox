...
class SeatImpl : public ActionStation<Base>
{
	private:
		...
		// "Backend" connections
		wbx::signals::scoped_connection seatTouched;
		wbx::signals::scoped_connection humanoidDoneSitting;
...
public:
	...
	wbx::remote_signal<void(shared_ptr<Instance>)> createSeatWeldSignal;
	wbx::remote_signal<void()> destroySeatWeldSignal;
