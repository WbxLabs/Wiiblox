...
namespace WBX 
{
	...
	public:
		...
		wbx::remote_signal<void(std::string, shared_ptr<Instance>, int)> serverCollectResultSignal;
		wbx::remote_signal<void(bool, std::string, shared_ptr<Instance>, int)> serverCollectConditionalResultSignal;
	...
	private:
		...
		wbx::signals::scoped_connection resultCollectConnection;
		wbx::signals::scoped_connection conditionalResultCollectConnection;
