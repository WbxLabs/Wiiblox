...
#ifdef _WIN32
#if defined(_NOOPT) || defined(_DEBUG) || defined(WBX_TEST_BUILD)
...
namespace WBX {
	...
	private:
        ...
        std::string url;
        wbx::Timer<wbx::Time::Fast> retryTimer;
    ...
    public:
		...
		wbx::signal<void(shared_ptr<Instance>, Reflection::Variant)> playerArrivedFromTeleportSignal;
