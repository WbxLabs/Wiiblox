	...
	#define IMPLEMENT_GUI_IMAGE_MIXIN(Class) \
		...
		{													\
			if(imageRectOffset != value){					\
				...
				{																																	\
					wbx::StandardOut::singleton()->printf(MESSAGE_WARNING,"SliceCenter ((%f,%f), (%f,%f)) is outside the bounds of imageOffset ((%f,%f), (%f,%f)).", offsetSliceCenter.x0(),offsetSliceCenter.y0(),offsetSliceCenter.x1(), offsetSliceCenter.y1(), imageRect.x0(),imageRect.y0(),imageRect.x1(), imageRect.y1()); \
				}																																	\
