...
namespace WBX { namespace Voxel2 { class MaterialTable; class Grid; } }
...
public:
	...
	/*override*/ virtual void setPartSizeXml(const Vector3& WBXSize);
	/*override*/ virtual void setPartSizeUi(const Vector3& WBXSize);
    ...
    /*override*/ Surface getSurface(const WBXRay& gridRay, int& surfaceId);
