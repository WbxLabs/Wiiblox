...
namespace WBX {
		...
		:public DescribedNonCreatable<DataStore, Instance, sGlobalDataStore, Reflection::ClassDescriptor::RUNTIME_LOCAL>
	{
		...
		typedef std::map<std::string, shared_ptr<wbx::signal<void(Reflection::Variant)> > > OnUpdateKeys;
	...
	public:	
		...
		wbx::signals::connection onUpdate(std::string key, Lua::WeakFunctionRef callback);
