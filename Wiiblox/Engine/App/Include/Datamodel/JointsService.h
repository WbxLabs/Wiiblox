...
namespace WBX {
	...
	private:
		...
		wbx::signals::scoped_connection postInertJointConnection;
		wbx::signals::scoped_connection postDestroyJointConnection;
		wbx::signals::scoped_connection autoJoinConnection;
		wbx::signals::scoped_connection autoDestroyConnection;
