...
namespace WBX {
	...
	public:
		...
		class special_equipped_signal : public wbx::signals::signal_with_args<1, void(shared_ptr<Instance>)> //wbx::signal<void(shared_ptr<Instance>)>
		{
		private:
			typedef wbx::signals::signal_with_args<1, void(shared_ptr<Instance>)> Super;
		...
		public:
			...
			wbx::signals::connection connect(Delegate& function) {
				wbx::signals::connection result = Super::connect(function);
	...
	private:
		...
		// "Backend" connections
		wbx::signals::scoped_connection_logged handleTouched;			// watches for handle touched
		wbx::signals::scoped_connection characterChildAdded;		
		wbx::signals::scoped_connection characterChildRemoved;		
		wbx::signals::scoped_connection torsoChildAdded;			
		wbx::signals::scoped_connection torsoChildRemoved;
		wbx::signals::scoped_connection armChildAdded;			
	...
	public:
		...
		wbx::remote_signal<void()> activatedSignal;
		wbx::signal<void()> unequippedSignal;
		wbx::remote_signal<void()> deactivatedSignal;
