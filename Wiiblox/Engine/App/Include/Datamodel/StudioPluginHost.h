...
namespace WBX {
	...
	public:
		...
		virtual void fireDragEnterEvent(DataModel* dataModel, shared_ptr<const wbx::Instances> instances, Vector2 location) = 0;
	};
	...
	public:
        ...
        virtual void setSetting(int assetId, const std::string& key, const wbx::Reflection::Variant& value) = 0;
		virtual void getSetting(int assetId, const std::string& key, wbx::Reflection::Variant* result) = 0;
		...
		virtual void exportPlace(std::string filePath, wbx::ExporterSaveType exportType) = 0;
