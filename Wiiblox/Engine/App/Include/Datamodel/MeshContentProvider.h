...
namespace WBX {
	...
	class MeshContentProvider 
		: public DescribedNonCreatable<MeshContentProvider, CacheableContentProvider, sMeshContentProvider, wbx::Reflection::ClassDescriptor::RUNTIME_LOCAL>
	{
		typedef DescribedNonCreatable<MeshContentProvider, CacheableContentProvider, sMeshContentProvider, wbx::Reflection::ClassDescriptor::RUNTIME_LOCAL> Super;
