...
namespace WBX
{
	...
	public:
		...
		wbx::signal<void(ValueType)> valueChangedSignal;
	...
	typedef Value<wbx::WBXRay, sRayValue> RayValue;
	...
	typedef Value<wbx::BrickColor, sBrickColorValue> BrickColorValue;

    extern const char* const sBinaryStringValue;
    typedef Value<wbx::BinaryString, sBinaryStringValue> BinaryStringValue;
	...
	public:
		...
		wbx::signal<void(std::string)> valueChangedSignal;
	...
	public:
		...
		static wbx::Reflection::RefPropDescriptor<ObjectValue, Instance> desc_Value;
		wbx::signal<void(shared_ptr<Instance>)> valueChangedSignal;
	protected:
		virtual bool askSetParent(const Instance* instance) const {
			// Values are willing to be placed anywhere
			return true;
