...
namespace WBX {
	...
	namespace Stats
	{
		...
		class StatsService 
			: public DescribedNonCreatable<StatsService, Instance, sStats, Reflection::ClassDescriptor::INTERNAL_LOCAL, wbx::Security::LocalUser>
			, public Service
		{
			std::string customReportUrl;
			typedef boost::unordered_map<std::string, wbx::Time> LastReportTimes;
			LastReportTimes lastReportTimes;
			wbx::signals::scoped_connection baseUrlConnection;
		public:
			StatsService():DescribedNonCreatable<StatsService, Instance, sStats, Reflection::ClassDescriptor::INTERNAL_LOCAL, wbx::Security::LocalUser>("Stats") 
