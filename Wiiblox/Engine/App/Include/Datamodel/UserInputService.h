...
namespace WBX
{
	...
	private:
        ...
        typedef std::vector< std::pair<UserInputService::Gesture, std::pair<shared_ptr<wbx::Reflection::ValueArray>,shared_ptr<const Reflection::Tuple> > > > GestureEventsVector;
        ...
        static wbx::Color3 DrawTouchColor;
        static wbx::Color3 DrawMoveColor;
        shared_ptr<wbx::Frame> drawTouchFrame;
		...
		shared_ptr<wbx::InputObject> mouseEventObject;

        float maxWalkDelta;
        wbx::Vector2 walkDirection;
        wbx::Vector2 lastWalkDirection;
        ...
        wbx::Vector2 cameraPanDelta;
        float cameraZoom;
		wbx::Vector2 cameraMouseTrack;
		wbx::Vector2 cameraMouseWrap;
		...
		// Keyboard Stuff
		boost::unordered_map<wbx::KeyCode, shared_ptr<InputObject> > newKeyState;
		std::vector<std::pair<wbx::KeyCode, wbx::ModCode> > modPairs;
		bool capsLocked;
		...
		wbx::ModCode getCurrentModKey();

		void clearKeyStateInternal();
		void setKeyStateInternal(wbx::KeyCode keyCode, ModCode modCode, char modifiedKey, bool isDown);
        ...
        void fireGestureEvent(const UserInputService::Gesture gesture, const shared_ptr<const wbx::Reflection::ValueArray>& touchPositions, const shared_ptr<const Reflection::Tuple>& args, const bool wasSunk = false);
    ...
    public:
		...
		static Reflection::EventDesc<UserInputService, 
			...
			wbx::signal<void(shared_ptr<Instance>, bool)>* (UserInputService::*)(bool)> event_InputBegin;
		static Reflection::EventDesc<UserInputService, 
			void(shared_ptr<Instance>, bool), 
			wbx::signal<void(shared_ptr<Instance>, bool)>,
			wbx::signal<void(shared_ptr<Instance>, bool)>* (UserInputService::*)(bool)> event_InputUpdate;
		static Reflection::EventDesc<UserInputService, 
			void(shared_ptr<Instance>, bool), 
			wbx::signal<void(shared_ptr<Instance>, bool)>,
			wbx::signal<void(shared_ptr<Instance>, bool)>* (UserInputService::*)(bool)> event_InputEnd;
        ...
        wbx::signal<void(bool, void*, const shared_ptr<wbx::InputObject>&)> processedMouseEvent;
        wbx::signal<void(shared_ptr<Instance>, bool)> processedEventSignal;
        
        // touch gesture event signals
        wbx::signal<void(shared_ptr<const Reflection::ValueArray>, bool)> tapGestureEvent;
        wbx::signal<void(shared_ptr<const Reflection::ValueArray>, float, float, InputObject::UserInputState, bool)> pinchGestureEvent;
        wbx::signal<void(SwipeDirection, int, bool)> swipeGestureEvent;
        wbx::signal<void(shared_ptr<const Reflection::ValueArray>, InputObject::UserInputState, bool)> longPressGestureEvent;
        wbx::signal<void(shared_ptr<const Reflection::ValueArray>, float, float, InputObject::UserInputState, bool)> rotateGestureEvent;
        wbx::signal<void(shared_ptr<const Reflection::ValueArray>, wbx::Vector2, wbx::Vector2, InputObject::UserInputState, bool)> panGestureEvent;
        
        // low level touch event signals
        wbx::signal<void(shared_ptr<Instance>, bool)> touchStartedEvent;
		wbx::signal<void(shared_ptr<Instance>, bool)> coreTouchStartedEvent;

        wbx::signal<void(shared_ptr<Instance>, bool)> touchEndedEvent;
		wbx::signal<void(shared_ptr<Instance>, bool)> coreTouchEndedEvent;

        wbx::signal<void(shared_ptr<Instance>, bool)> touchMovedEvent;
		wbx::signal<void(shared_ptr<Instance>, bool)> coreTouchMovedEvent;

		wbx::signal<void(shared_ptr<Instance>, bool)>* getTouchBeganEvent(bool whatever = true);
		wbx::signal<void(shared_ptr<Instance>, bool)>* getTouchChangedEvent(bool whatever = true);
		wbx::signal<void(shared_ptr<Instance>, bool)>* getTouchEndedEvent(bool whatever = true);

		// low level generic event signals
		wbx::signal<void(shared_ptr<Instance>, bool)> inputBeganEvent;
		wbx::signal<void(shared_ptr<Instance>, bool)> coreInputBeganEvent;

		wbx::signal<void(shared_ptr<Instance>, bool)> inputUpdatedEvent;
		wbx::signal<void(shared_ptr<Instance>, bool)> coreInputUpdatedEvent;

		wbx::signal<void(shared_ptr<Instance>, bool)> inputEndedEvent;
		wbx::signal<void(shared_ptr<Instance>, bool)> coreInputEndedEvent;

		wbx::signal<void(shared_ptr<Instance>, bool)>* getInputBeganEvent(bool whatever = true);
		wbx::signal<void(shared_ptr<Instance>, bool)>* getInputChangedEvent(bool whatever = true);
		wbx::signal<void(shared_ptr<Instance>, bool)>* getInputEndedEvent(bool whatever = true);
        
        // Motion Events
        wbx::signal<void(shared_ptr<Instance>, CoordinateFrame)> gyroChangedSignal;
        wbx::signal<void(shared_ptr<Instance>)> accelerometerChangedSignal;
        wbx::signal<void(shared_ptr<Instance>)> gravityChangedSignal;
        
        wbx::signal<void(shared_ptr<Instance>, CoordinateFrame)>* getOrCreateScriptGyroEventSignal(bool create = true);
        wbx::signal<void(shared_ptr<Instance>)>* getOrCreateScriptAccelerometerEventSignal(bool create = true);
        wbx::signal<void(shared_ptr<Instance>)>* getOrCreateScriptGravityEventSignal(bool create = true);
        
        wbx::signal<void(std::string)> motionEventListeningStarted;
        
        // Text Events
        wbx::signal<void(shared_ptr<wbx::Instance>)> textBoxGainFocus;
        wbx::signal<void(shared_ptr<wbx::Instance>)> textBoxReleaseFocus;
        wbx::signal<void(const char*, bool, const shared_ptr<InputObject>&)> textBoxFinishedEditing;

		wbx::signals::connection textboxFocusBeganConnection;
		wbx::signals::connection textboxFocusEndedConnection;

		// Gamepad Events
		wbx::signal<void(InputObject::UserInputType)> gamepadDisconnectedSignal;
		wbx::signal<void(InputObject::UserInputType)> gamepadConnectedSignal;
		wbx::signal<void(InputObject::UserInputType)> getSupportedGamepadKeyCodesSignal;

		// Window Event
		wbx::signal<void()> windowFocused;
		wbx::signal<void()> windowFocusReleased;
        
        // Misc Events
     	wbx::signal<void()> jumpRequestEvent;
		wbx::signal<void(bool)> mouseIconEnabledEvent;
        wbx::signal<void()> updateInputSignal;
        wbx::signal<void(InputObject::UserInputType)> lastInputTypeChangedSignal;
        ...
        void fireAccelerationEvent(const wbx::Vector3& newAcceleration);
        void fireRotationEvent(const wbx::Vector3& newRotation, const wbx::Vector4& quaternion);
        void fireGravityEvent(const wbx::Vector3& newGravity);
        ...
        // Keyboard Functions
		static char getModifiedKey(wbx::KeyCode key, wbx::ModCode mod);

		void setKeyState(wbx::KeyCode keyCode, ModCode m, char key, bool isDown);
		bool isKeyDown(wbx::KeyCode keyCode);
		bool isCapsLocked();
		void resetKeyState();
		...
		bool gamepadSupports(InputObject::UserInputType gamepadType, wbx::KeyCode keyCode);
        ...
        void addGestureEventToProcess(const UserInputService::Gesture gesture, shared_ptr<wbx::Reflection::ValueArray>& touchPositions, shared_ptr<Reflection::Tuple>& args);
        ...
        std::vector<wbx::ModCode> getCommandModCodes(); // returns control for windows, command for os x, etc.
        
        // local character manipulations
        void jumpLocalCharacterLua();
        void moveLocalCharacterLua(Vector2 walkDir, float maxWalkDelta);
        void moveLocalCharacter(wbx::Vector2 movementVector, float maxMovementDelta);
        void jumpLocalCharacter(bool jumpValue);
        void jumpOnceLocalCharacter(bool jumpValue);

        // camera manipulations
        void rotateCameraLua(wbx::Vector2 mouseDelta);
        void rotateCamera(wbx::Vector2 mouseDelta);
		void wrapCamera(wbx::Vector2 mouseWrap);
        
        void zoomCameraLua(float zoom);
        void zoomCamera(float zoom);

		void mouseTrackCamera(wbx::Vector2 mouseDelta);
        
        // raw input mechanisms
        void sendMouseEvent(const shared_ptr<wbx::InputObject>& event, void* nativeEventObject);
        void processToolEvent(const shared_ptr<wbx::InputObject>& event);
        ...
        wbx::signal<void(UserCFrame, CoordinateFrame)> userCFrameChanged;
