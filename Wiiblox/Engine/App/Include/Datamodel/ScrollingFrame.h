...
namespace WBX
{
    ...
    private:
		...
		wbx::Timer<wbx::Time::Fast> selectionTimer;
		...
		wbx::Timer<wbx::Time::Fast> wheelUpTimer;
		wbx::Timer<wbx::Time::Fast> wheelDownTimer;
        wbx::Timer<wbx::Time::Fast> touchDeltaTimer;
        
        wbx::signals::scoped_connection inputEndedConnection;
		wbx::signals::scoped_connection guiServicePropertyChangedConnection;
		wbx::signals::scoped_connection selectionGainedConnection;
		wbx::signals::scoped_connection selectionLostConnection;
		...
		void selectedGuiObjectChanged(const wbx::Reflection::PropertyDescriptor* desc);
