...
private:
	...
	/*override*/ const Name& getClassName() const	{return Name::getNullName(); }
...
class GuiRoot : 
	public Reflection::Described<GuiRoot, sGuiRoot, GuiItem, Reflection::ClassDescriptor::INTERNAL_LOCAL, wbx::Security::LocalUser> 
{
public:
	GuiRoot();
