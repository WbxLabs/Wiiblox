...
namespace WBX {
	...
	private:
		...
		wbx::signals::scoped_connection playerChatMessageConnection;
		wbx::signals::scoped_connection gameChatMessageConnection;
