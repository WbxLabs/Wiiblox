...
namespace WBX {
	...
	private:
		...
		wbx::TextureProxyBaseRef disable;
		wbx::TextureProxyBaseRef normal;
		wbx::TextureProxyBaseRef hover;
		wbx::TextureProxyBaseRef down;
		wbx::TextureProxyBaseRef selected;
		wbx::TextureProxyBaseRef selectedHover;
		wbx::TextureProxyBaseRef selectedDown;
		mutable Vector2 size;
		wbx::signals::scoped_connection unbindResourceSignalHint;

		void OnUnbindResourceSignalHint();

		void draw(Adorn* adorn, const wbx::TextureProxyBaseRef& texture, const Rect& rect, const Vector2& texul, const Vector2& texbr, const Color4& color,
		...
		void tryCreateTextureProxy(Adorn *adorn, const std::string& contentString, const std::string& context, wbx::TextureProxyBaseRef& textureRef, bool& isWaiting);
	public:
