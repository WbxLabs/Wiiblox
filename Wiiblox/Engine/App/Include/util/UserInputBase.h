...
namespace WBX {
	...
	public:
		...
		wbx::signal<void()> cursorIdChangedSignal;
        ...
        virtual void setKeyState(wbx::KeyCode code, wbx::ModCode modCode, char modifiedKey, bool isDown) = 0;

		/////////////////////////////////////////////////////////////////////
		// Cursor Handling
		//
		ContentId getCurrentCursorId() { return currentCursorId; }
		virtual bool setCursorId(wbx::Adorn *adorn, const wbx::TextureId& id);
