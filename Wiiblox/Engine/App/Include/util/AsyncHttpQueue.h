...
protected:
	...
	struct Request
	{
		...
		wbx::Time startTime; // the time when this request was issued
	...
	static void processRequests(boost::weak_ptr<AsyncHttpQueue> httpQueue, RequestHandle request, boost::shared_ptr<wbx::spin_mutex> lock);
