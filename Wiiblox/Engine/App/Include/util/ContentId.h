...
namespace WBX {
	...
	public:
		...
		bool isAsset() const { return id.compare(0, 11, "WBXasset://") == 0; }
		bool isAssetId() const { return id.compare(0, 13, "wbxassetid://") == 0; }
		bool isHttp() const { return id.compare(0, 4, "http") == 0; }
		bool isFile() const { return id.compare(0, 7, "file://") == 0; }
		bool isWBXHttp() const { return id.compare(0, 10, "WBXhttp://") == 0; }
		bool isAppContent() const { return id.compare(0, 9, "WBXapp://") == 0; }
