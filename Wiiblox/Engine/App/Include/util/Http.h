...
namespace WBX
{
	...
	public:
		...
		static std::string gameSessionID; // additional header to be sent in POST requests to Wiiblox
		static std::string gameID;
		static std::string placeID;
		static std::string requester;
        static std::string WBXUserAgent;
        ...
        static const std::string kWBXAuthenticationNegotiation;
	...
	private:
		...
		static wbx::mutex *WiibloxResponceLock;
		static wbx::mutex *cdnResponceLock;
	...
	public:
        ...
        static wbx::atomic<int> cdnSuccessCount;
        static wbx::atomic<int> cdnFailureCount;
        static wbx::atomic<int> alternateCdnSuccessCount;
        static wbx::atomic<int> alternateCdnFailureCount;
		static double lastCdnFailureTimeSpan;
        static wbx::atomic<int> WiibloxSuccessCount;
        static wbx::atomic<int> WiibloxFailureCount;

		static WindowAverage<double, double> WiibloxResponce;
		static WindowAverage<double, double> cdnResponce;

		static wbx::mutex *getWiibloxResponceLock();
		static wbx::mutex *getCdnResponceLock();
        ...
        void setAuthDomain(std::string domain)
        {
            ...
            additionalHeaders[kWBXAuthenticationNegotiation] = domain;
        }
		...
		static bool isWiibloxSite(const char* url);
        static bool isStrictlyWiibloxSite(const char* url);
		...
		void applyAdditionalHeaders(wbx::HttpAux::AdditionalHeaders& outHeaders);
