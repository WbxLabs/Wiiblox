...
struct Header
{
#define WBX_CACHE_FILE_MAGIC            0x52425848 // WBXH
#define WBX_CACHE_FILE_VERSION          0x1
#define WBX_CACHE_URL_MAX_LENGTH        1024U

    const uint32_t magic;
    const uint32_t version;
    const uint32_t urlBytes;
    const uint8_t  url[WBX_CACHE_URL_MAX_LENGTH]; // not null-terminated
...
boost::filesystem::path getWiibloxCookieJarPath();
