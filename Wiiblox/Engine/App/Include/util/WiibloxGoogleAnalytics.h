...
namespace WiibloxGoogleAnalytics
{
    ...
    void lotteryInit(const std::string &accountPropertyID, size_t maxThreadScheduleSize, int lotteryThreshold, const char * productName = NULL, int WiibloxAnalyticsLottery = -1, const std::string &sessionKey = "sessionID=");
