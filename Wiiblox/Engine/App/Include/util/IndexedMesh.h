...
namespace WBX {
	...
	public:
		...
		template<class Type>
		Type* getTypedLower() {
			return WBX_static_cast<Type*>(getLower());
		}

		template<class Type>
		const Type* getConstTypedLower() const {
			return WBX_static_cast<const Type*>(getConstLower());
		}

		template<class Type>
		Type* getTypedUpper() {
			return WBX_static_cast<Type*>(getUpper());
		}

		template<class Type>
		const Type* getConstTypedUpper() const {
			return WBX_static_cast<const Type*>(getConstUpper());
		}
