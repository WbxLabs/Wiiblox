...
#include "wbx/intrusive_ptr_target.h"
...
namespace WBX
{
	...
	public:
		...
		public:
			...
			void setNull() { name = &Name::getNullName(); }
			bool isNull() const {
				return *name == Name::getNullName();
			}
			void set( const std::string& s )
			{
				name = &Name::declare(s.c_str());
			}
	...
	public:
		...
		static const wbx::Guid::Scope& getLocalScope();

		static void generateWBXGUID(wbx::Guid::Scope& result);
		
		// Creates a string like this: WBXc200e36038c511ceae6208002b2b79ef
		static void generateWBXGUID(std::string& result);
	...
	public:
		...
		class Registry
			: public wbx::quick_intrusive_ptr_target<Registry>
		{
