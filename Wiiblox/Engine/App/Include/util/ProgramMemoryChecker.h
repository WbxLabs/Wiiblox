...
namespace Security{
    ...
    extern volatile const size_t WBXGoldHash;

    // The lower part of .text
    extern volatile const uintptr_t WBXLowerBase;
    extern volatile const size_t WBXLowerSize;

    // The upper part of .text
    extern volatile const uintptr_t WBXUpperBase;
    extern volatile const size_t WBXUpperSize;

    // the .rdata section
    extern volatile const uintptr_t WBXRdataBase;
    extern volatile const size_t WBXRdataSize;
    ...
    extern volatile const uintptr_t WBXIatBase;
    extern volatile const size_t WBXIatSize;

    // the vmp sections (plain .text section)
    extern volatile const uintptr_t WBXVmpPlainBase;
    extern volatile const size_t WBXVmpPlainSize;

    // the vmp sections (mutation .text section)
    extern volatile const uintptr_t WBXVmpMutantBase;
    extern volatile const size_t WBXVmpMutantSize;

    // the vmp sections (don't know)
    extern volatile const uintptr_t WBXVmp0MiscBase;
    extern volatile const size_t WBXVmp0MiscSize;

    // the vmp sections (don't know)
    extern volatile const uintptr_t WBXVmp1MiscBase;
    extern volatile const size_t WBXVmp1MiscSize;

    // the .rdata section without IAT
    extern volatile const uintptr_t WBXRdataNoIatBase;
    extern volatile const size_t WBXRdataNoIatSize;
}
