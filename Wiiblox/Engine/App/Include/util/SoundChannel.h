...
namespace WBX {
	...
	namespace Soundscape
	{
		...
		private:
			...
			wbx::Timer<wbx::Time::Fast> lastTimePosReplication; // to regulate how often we replicate the time
			...
			wbx::signals::scoped_connection serverUpdatedTimeConnection;
			wbx::signals::scoped_connection serverScriptUpdatedTimeConnection;
			wbx::signals::scoped_connection serverResumedSoundConnection;
		...
		public:
			wbx::signal<void(std::string soundId, int)> soundLoopedSignal;
			wbx::signal<void(std::string soundId)> soundPausedSignal;
			wbx::signal<void(std::string soundId)> soundStoppedSignal;
			wbx::signal<void(std::string soundId)> soundPlayedSignal;
			wbx::signal<void(std::string soundId)> soundEndedSignal;

			wbx::remote_signal<void(int)> timePositionUpdatedFromServerSignal;
			wbx::remote_signal<void(int)> timePositionUpdatedFromServerScriptSignal;

			wbx::remote_signal<void(int)> soundResumedFromServerSignal;
