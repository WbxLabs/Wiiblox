...
enum StringIDs {
	...
	ScriptStr = 10, //Script
	Rocky = 11,//rocky
	HasGamePassLuaWarning = 12, //Game passes can only be queried by a Script running on a Wiiblox game server
	NoTeleportInStudio = 13, //Teleporting while using Wiiblox Studio is not permitted
