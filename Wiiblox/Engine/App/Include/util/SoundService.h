...
namespace WBX 
{
	...
	namespace Soundscape
	{
		...
		private:
			...
			wbx::signals::scoped_connection gameSettingsChangedConnection;
		...
		public:
			...
			void setListener(ListenerType listenerType, shared_ptr<const wbx::Reflection::Tuple> value);
			shared_ptr<const wbx::Reflection::Tuple> getListener();
            ...
            static void checkResultNoThrow(FMOD_RESULT result, const char* fmodOperation, const void *WBXFmodParent, const void *fmodObject);
            static void checkResult(FMOD_RESULT result, const char* fmodOperation, const void *WBXFmodParent, const void *fmodObject);
