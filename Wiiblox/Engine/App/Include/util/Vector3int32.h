...
namespace WBX {
	...
	::std::size_t hash_value(const wbx::Vector3int32& v);

	inline wbx::Vector3int32 fastFloorInt32(const wbx::Vector3& v)
	{
		return wbx::Vector3int32(fastFloorInt(v.x), fastFloorInt(v.y), fastFloorInt(v.z));
	}
