...
namespace WBX
{
	...
	class CoreScript
		: public DescribedNonCreatable<CoreScript, BaseScript, sCoreScript, wbx::Reflection::ClassDescriptor::INTERNAL_LOCAL>
	{
	private:
		typedef DescribedNonCreatable<CoreScript, BaseScript, sCoreScript, wbx::Reflection::ClassDescriptor::INTERNAL_LOCAL> Super;
        Code code;
