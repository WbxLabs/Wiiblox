...
namespace WBX { namespace Lua {
	...
	class Region3Bridge : public Bridge<wbx::Region3>
	{
		friend class Bridge< wbx::Region3 >;
	public:
		static void registerClassLibrary (lua_State *L) ;

		static void pushRegion3(lua_State *L, const wbx::Region3& v)
		{
			pushNewObject(L, v);
		}
	private:
	...
	class Region3int16Bridge : public Bridge<wbx::Region3int16>
	{
		friend class Bridge< wbx::Region3int16 >;
	public:
		static void registerClassLibrary (lua_State *L);

		static void pushRegion3int16(lua_State *L, const wbx::Region3int16& v)
		{
			pushNewObject(L, v);
		}
	private:
	...
	class WBXRayBridge : public Bridge<wbx::WBXRay>
	{
		friend class Bridge< wbx::WBXRay >;
	public:
		static void registerClassLibrary (lua_State *L);
			
		static void pushRay(lua_State *L, const wbx::WBXRay& v)
		{
			pushNewObject(L, v);
		}
	private:
		static int newWBXRay(lua_State *L);
		//static int on_add(lua_State *L);
		//static int on_sub(lua_State *L);
		//static int on_mul(lua_State *L);
		//static int on_div(lua_State *L);
	...
	class Vector2Bridge : public Bridge<wbx::Vector2>
	{
		friend class Bridge< wbx::Vector2 >;
	public:
		static void registerClassLibrary (lua_State *L);

		static void pushVector2(lua_State *L, const wbx::Vector2& v)
		{
			pushNewObject(L, v);
		}
	private:
	...
	class Vector2int16Bridge : public Bridge<wbx::Vector2int16>
	{
		friend class Bridge< wbx::Vector2int16 >;
	public:
		static void registerClassLibrary (lua_State *L);

		static void pushVector2int16(lua_State *L, const wbx::Vector2int16& v)
		{
			pushNewObject(L, v);
		}
	private:
	...
	class UDimBridge : public Bridge<wbx::UDim>
	{
		friend class Bridge< wbx::UDim>;
	public:
		static void registerClassLibrary (lua_State *L);

		static void pushUDim(lua_State *L, const wbx::UDim& v)
		{
			pushNewObject(L, v);
		}
	private:
	...
	class UDim2Bridge : public Bridge<wbx::UDim2>
	{
		friend class Bridge< wbx::UDim2>;
	public:
		static void registerClassLibrary (lua_State *L);
	...
	class FacesBridge : public Bridge<wbx::Faces>
	{
		friend class Bridge< wbx::Faces>;
	public:
		static void registerClassLibrary (lua_State *L);
	...
	class AxesBridge : public Bridge<wbx::Axes>
	{
		friend class Bridge< wbx::Axes>;
	public:
		static void registerClassLibrary (lua_State *L);
	...
	class BrickColorBridge : public Bridge<wbx::BrickColor>
	{
		friend class Bridge< wbx::BrickColor >;
	public:
		static void registerClassLibrary (lua_State *L) ;
