...
namespace WBX
{
	...
	namespace Scripting
	{
		...
		private:
			...
			wbx::signals::connection errorSignalConnection;
			wbx::signals::connection descendantAddedSignalConnection;
		...
		public:			
			...
			void setDataModel(wbx::DataModel *pDataModel);
			wbx::DataModel* getDataModel();
			...
			wbx::signal<void(shared_ptr<Instance>)> debuggerAdded;
			wbx::signal<void(shared_ptr<Instance>)> debuggerRemoved;
		...
		protected:
			...
			void addUnaddedDebuggerForAddedDescendant(shared_ptr<wbx::Instance> instance);
		};
		...
		private:
			...
			wbx::signals::scoped_connection scriptStartedConnection;
			wbx::signals::scoped_connection scriptStoppedConnection;
			wbx::signals::scoped_connection scriptParentChangedConnection;
			wbx::signals::scoped_connection scriptClonedConnection;
		...
		public:
			...
			struct FunctionInfo
			{
				boost::shared_ptr<wbx::Instance> script;
				int frame;
				std::string name;
				std::string what;
				std::string namewhat;
			...
			wbx::signal<void(int)> encounteredBreak;
			wbx::signal<void()> resuming;
			
			wbx::signal<void(shared_ptr<Instance>)> breakpointAdded;
			wbx::signal<void(shared_ptr<Instance>)> breakpointRemoved;
			wbx::signal<void(shared_ptr<Instance>)> watchAdded;
			wbx::signal<void(shared_ptr<Instance>)> watchRemoved;
			wbx::signal<void(int, std::string, Stack)>   scriptErrorDetected;
		...
		private:
			...
			void onScriptParentChanged(shared_ptr<wbx::Instance> newParent);
			...
			static wbx::Instance* getScriptForLuaState(lua_State* L);
