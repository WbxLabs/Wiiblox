...
public:
    ...
    static WBX_SIMD_INLINE void setReaction( ConstraintVariables* _vars, const Vector3& _r )
    {
    ...
    static WBX_SIMD_INLINE void setReaction( ConstraintVariables* _vars, float x, float y )
    {
        _vars[0].reaction = x;
        _vars[1].reaction = y;
    }

    static WBX_SIMD_INLINE void setImpulse( ConstraintVariables* _vars, const Vector3& _i )
    {
    ...
    static WBX_SIMD_INLINE void setImpulse( ConstraintVariables* _vars, float x, float y )
    {
        _vars[0].impulse = x;
        _vars[1].impulse = y;
    }

    static WBX_SIMD_INLINE void setMinImpulses( ConstraintVariables* _vars, const Vector3& _min )
    {
    ...
    static WBX_SIMD_INLINE void setMinImpulses( ConstraintVariables* _vars, float x, float y )
    {
        _vars[0].minImpulseValue = x;
        _vars[1].minImpulseValue = y;
    }

    static WBX_SIMD_INLINE void setMaxImpulses( ConstraintVariables* _vars, const Vector3& _max )
    {
    ...
    static WBX_SIMD_INLINE void setMaxImpulses( ConstraintVariables* _vars, float x, float y )
    {
        _vars[0].maxImpulseValue = x;
        _vars[1].maxImpulseValue = y;
    }

    static WBX_SIMD_INLINE void gatherComponents( simd::v4f& _impulses, simd::v4f& _reactions, simd::v4f& _min, simd::v4f& _max, const ConstraintVariables& _vars0 )
    {
    ...
    static WBX_SIMD_INLINE void gatherComponents( simd::v4f& _impulses, simd::v4f& _reactions, simd::v4f& _min, simd::v4f& _max, const ConstraintVariables& _vars0, const ConstraintVariables& _vars1 )
    {
        transpose2x4( _min, _max, _reactions, _impulses, simd::v4f(_vars0.v), simd::v4f(_vars1.v) );
    }

    static WBX_SIMD_INLINE void gatherComponents( simd::v4f& _impulses, simd::v4f& _reactions, simd::v4f& _min, simd::v4f& _max, const ConstraintVariables& _vars0, const ConstraintVariables& _vars1, const ConstraintVariables& _vars2 )
    {
        transpose3x4( _min, _max, _reactions, _impulses, (simd::v4f)_vars0.v, (simd::v4f)_vars1.v, (simd::v4f)_vars2.v );
    }

    static WBX_SIMD_INLINE void gatherComponents( simd::v4f& _impulses, simd::v4f& _reactions, simd::v4f& _min, simd::v4f& _max, const ConstraintVariables& _vars0, const ConstraintVariables& _vars1, const ConstraintVariables& _vars2, const ConstraintVariables& _vars3 )
    {
...
#ifdef __WBX_NOT_RELEASE
static inline void checkConstraintVariables( const ConstraintVariables& _vars )
{
    RBXASSERT( !wbx::Math::isNanInf( _vars.impulse ) );
    RBXASSERT( !wbx::Math::isNanInf( _vars.reaction ) );
    RBXASSERT( !wbx::Math::isNan( _vars.minImpulseValue ) );
    RBXASSERT( !wbx::Math::isNan( _vars.maxImpulseValue ) );
}

static inline void checkJacobian( const ConstraintJacobianPair& _j )
{
    RBXASSERT( !wbx::Math::isNanInfVector3( _j.a.lin ) );
    RBXASSERT( !wbx::Math::isNanInfVector3( _j.b.lin ) );
    RBXASSERT( !wbx::Math::isNanInfVector3( _j.a.ang ) );
    RBXASSERT( !wbx::Math::isNanInfVector3( _j.b.ang ) );
}
#endif

WBX_SIMD_INLINE void Constraint::restoreCacheAndBuildEquation( 
...
WBX_SIMD_INLINE void Constraint::updateBrokenState(
    const ConstraintVariables* _velocityStage, 
    const ConstraintVariables* _positionStage, 
    const SolverConfig& _config ) 
{
