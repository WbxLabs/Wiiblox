...
namespace WBX
{
    ...
    {
    public:
        WBX_SIMD_INLINE Vector3 operator*( const Vector3& v ) const
        {
            Vector3 r;
        ...
        WBX_SIMD_INLINE SymmetricMatrix operator*( float s ) const
        {
            SymmetricMatrix r;
    ...
    {
    public:
        WBX_SIMD_INLINE SymmetricMatrixSIMD( const float* _m )
        {
            diagonals = simd::load3( _m );
            offDiagonals = simd::load3( _m + 3 );
        }

        WBX_SIMD_INLINE SymmetricMatrixSIMD( const simd::v4f& _diagonal, const simd::v4f& _offDiagonal ): diagonals( _diagonal ), offDiagonals( _offDiagonal ) { }

        WBX_SIMD_INLINE SymmetricMatrixSIMD( const SymmetricMatrixPOD& _m ): diagonals( _m.diagonals ), offDiagonals( _m.offDiagonals ) { }

        template< int row, int column >
        WBX_SIMD_INLINE simd::v4f get() const;

        WBX_SIMD_INLINE simd::v4f operator*( const simd::v4f& v ) const
        {
    ...
    template< >
    WBX_SIMD_INLINE simd::v4f SymmetricMatrixSIMD::get<0,0>() const { return simd::splat<0>( diagonals ); }
    template< > 
    WBX_SIMD_INLINE simd::v4f SymmetricMatrixSIMD::get<1,1>() const { return simd::splat<1>( diagonals ); }
    template< > 
    WBX_SIMD_INLINE simd::v4f SymmetricMatrixSIMD::get<2,2>() const { return simd::splat<2>( diagonals ); }
    template< >
    WBX_SIMD_INLINE simd::v4f SymmetricMatrixSIMD::get<0,1>() const { return simd::splat<0>( offDiagonals ); }
    template< > 
    WBX_SIMD_INLINE simd::v4f SymmetricMatrixSIMD::get<0,2>() const { return simd::splat<1>( offDiagonals ); }
    template< > 
    WBX_SIMD_INLINE simd::v4f SymmetricMatrixSIMD::get<1,2>() const { return simd::splat<2>( offDiagonals ); }
    template< >
    WBX_SIMD_INLINE simd::v4f SymmetricMatrixSIMD::get<1,0>() const { return get<0,1>(); }
    template< > 
    WBX_SIMD_INLINE simd::v4f SymmetricMatrixSIMD::get<2,0>() const { return get<0,2>(); }
    template< > 
    WBX_SIMD_INLINE simd::v4f SymmetricMatrixSIMD::get<2,1>() const { return get<1,2>(); }

    static WBX_SIMD_INLINE SymmetricMatrixSIMD operator*( const simd::v4f& s, const SymmetricMatrixSIMD& m )
    {
    ...
    {
    public:
        WBX_SIMD_INLINE SymmetricMatrix2SIMD( ) { }

        WBX_SIMD_INLINE SymmetricMatrix2SIMD( const simd::v4f& d00, const simd::v4f& d11, const simd::v4f& d01 )
        {
            m = simd::gatherX( d00, d01, d01, d11 );
        }

        WBX_SIMD_INLINE void load( const float* _m )
        {
            m = simd::form( _m[0], _m[2], _m[2], _m[1] );
        }

        WBX_SIMD_INLINE void form( const simd::v4f& d00, const simd::v4f& d11, const simd::v4f& d01 )
        {
            m = simd::gatherX( d00, d01, d01, d11 );
        }
    ...
    template<  >
    WBX_SIMD_INLINE simd::v4f SymmetricMatrix2SIMD::get<0,0>() const { return simd::splat<0>( m ); }
    template<  >
    WBX_SIMD_INLINE simd::v4f SymmetricMatrix2SIMD::get<1,0>() const { return simd::splat<1>( m ); }
    template<  >
    WBX_SIMD_INLINE simd::v4f SymmetricMatrix2SIMD::get<0,1>() const { return simd::splat<1>( m ); }
    template<  >
    WBX_SIMD_INLINE simd::v4f SymmetricMatrix2SIMD::get<1,1>() const { return simd::splat<3>( m ); }
    ...
    public:
        ...
        WBX_SIMD_INLINE SymmetricMatrixSIMD getInvInertiaVelStage() const
        {
            return inertiaSIMD;
        }

        WBX_SIMD_INLINE SymmetricMatrixSIMD getInvInertiaPosStage( float scale ) const
        {
        ...
        WBX_SIMD_INLINE simd::v4f getInvMassVelStage() const
        {
            return simd::splat( massInvVelStage );
        }

        WBX_SIMD_INLINE simd::v4f getInvMassPosStage() const
        {
        ...
        WBX_SIMD_INLINE simd::v4f getInvMass() const;

        template< class StageSelect >
        WBX_SIMD_INLINE SymmetricMatrixSIMD getInvInertia( float scale ) const;
    ...
    template<>
    WBX_SIMD_INLINE simd::v4f SolverBodyMassAndInertia::getInvMass< SolverBodyMassAndInertia::VelStage >() const
    {
        return getInvMassVelStage();
    }

    template<>
    WBX_SIMD_INLINE simd::v4f SolverBodyMassAndInertia::getInvMass< SolverBodyMassAndInertia::PosStage >() const
    {
        return getInvMassPosStage();
    }

    template< >
    WBX_SIMD_INLINE SymmetricMatrixSIMD SolverBodyMassAndInertia::getInvInertia< SolverBodyMassAndInertia::VelStage >( float scale ) const
    {
        return getInvInertiaVelStage();
    }

    template< >
    WBX_SIMD_INLINE SymmetricMatrixSIMD SolverBodyMassAndInertia::getInvInertia< SolverBodyMassAndInertia::PosStage >( float scale ) const
    {
