...
namespace WBX {
	...
	public:
		...
		struct {
			union {
				wbx::NormalId	normalID0;
				float			radius0;		};
			union {
				wbx::NormalId	normalID1;
				float			radiusSum;		};
			union {
				wbx::NormalId	planeID;// edge/edge/plane coords - the normal from the plane
				int				point0ID;		};
		} pairData;
	...
	public:
		...
		void setPointPlane(const Vector3* _offsetPoint,
							const Vector3* _offsetPlane, int _pointID, wbx::NormalId _planeNormalID) {
		...
		void setEdgeEdgePlane(const Vector3* _edge0, const Vector3* _edge1, 
				wbx::NormalId _normal0, wbx::NormalId _normal1, wbx::NormalId _planeID, float _edgeLength0, float _edgeLength1) {
			offset0 = *_edge0;
			offset1 = *_edge1;
		...
		void setEdgeEdge(const Vector3* _edge0, const Vector3* _edge1, 
							wbx::NormalId _normal0, wbx::NormalId _normal1) {
			offset0 = *_edge0;
			offset1 = *_edge1;
			pairData.normalID0 = _normal0;
			pairData.normalID1 = _normal1;
