...
namespace WBX {
	...
	private:
		...
		static void searchUpGross_EXT(	std::vector<wbx::Extents> &primExtents,
		...
		static void searchDownGross_EXT(	std::vector<wbx::Extents> &primExtents,
											const G3D::Array<Primitive*>& primitives, 
											const boost::unordered_set<const Primitive*> &ignorePrimitives,
											ContactManager& contactManager,
											const float bottomPlaneHeight,
		...
		static void searchUpFine_EXT(	std::vector<wbx::Extents> &primExtents,
										const G3D::Array<Primitive*>& primitives, 
										const boost::unordered_set<const Primitive*> &ignorePrimitives,
										ContactManager& contactManager,
										const float bottomPlaneHeight,
		...
		static void searchDownFine_EXT(	std::vector<wbx::Extents> &primExtents,
										const G3D::Array<Primitive*>& primitives, 
										const boost::unordered_set<const Primitive*> &ignorePrimitives,
										ContactManager& contactManager,
										const float bottomPlaneHeight,
		...
		static bool intersectingWorldOrOthers_EXT(	std::vector<wbx::Extents> &primExtents,
													const G3D::Array<Primitive*>& primitives, 
													const boost::unordered_set<const Primitive*> &ignorePrimitives,
													ContactManager& contactManager,
													const float bottomPlaneHeight,  
		...
		static bool intersectingGroundPlane_EXT(	const std::vector<wbx::Extents>& primExtents, 
													const G3D::Array<Primitive*>& primitives, 
													const float yHeight, 
													const Vector3& movedSoFar);
		...
		static void moveExtents(std::vector<wbx::Extents> &primExtents, const Vector3& delta);
		static void moveExtentsDelta(std::vector<wbx::Extents> &primExtents, const Vector3& delta, Vector3& movedSoFar);
