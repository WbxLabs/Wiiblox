...
namespace WBX {
	...
	private:
		...
		void tryStartDragging(const wbx::WBXRay& unitMouseRay);
		void startDragging();
		void doDrag(const wbx::WBXRay& unitMouseRay);
		bool getSnapHitPoint(PartInstance* part, const wbx::WBXRay& unitMouseRay, Vector3& hitPoint);
	...
	public:
		...
		void mouseMove(wbx::WBXRay mouseRay);		// inefficient, but easier to have just one version
