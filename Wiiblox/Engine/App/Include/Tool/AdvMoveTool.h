...
namespace WBX {
	...
	private:
		...
		typedef std::map<boost::weak_ptr<wbx::PartInstance>, float> PartsTransparencyCollection;
		...
		wbx::signals::scoped_connection selectionChangedConnection;
		void setToSelection();
	...
	private:
		...
		void getGridXYUsingCamera(wbx::PartInstance *part, G3D::Vector3 &gridXDir, G3D::Vector3 &gridYDir);
