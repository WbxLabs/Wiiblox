...
namespace WBX
{
	namespace Reflection
	{
		...
		public:
			...
			virtual void read(DescribedBase* instance, const XmlElement* element, wbx::IReferenceBinder& binder) const;
		private:
			virtual void writeValue(const DescribedBase* instance, XmlElement* element) const = 0;
			virtual void readValue(DescribedBase* instance, const XmlElement* element, wbx::IReferenceBinder& binder) const = 0;
			//\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\/
		...
		public:
			...
			inline void read(const XmlElement* element, wbx::IReferenceBinder& binder)
			{
		...
		class WBXInterface EnumPropertyDescriptor : public PropertyDescriptor {
		public:
		...
		public:
            ...
            {
                static const Name& name = Name::lookup("Object");
