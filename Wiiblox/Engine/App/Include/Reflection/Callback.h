	...
	namespace Reflection
	{
		...
		protected:
				...
				:SyncCallbackDesc<Signature>(classDescriptor, name, attributes, security)
			{
				...
				this->signature.resultType = &Type::singleton<result_type>();
				this->signature.addArgument(Name::declare(arg1name), Type::singleton<typename boost::function_traits<Signature>::arg1_type>());
			}
		public:
			virtual void setGenericCallback(DescribedBase* object, shared_ptr<SyncCallbackDescriptor::GenericFunction> function) const
			{
		...
		protected:
				...
				:SyncCallbackDesc<Signature>(classDescriptor, name, attributes, security)
			{
				...
				this->signature.resultType = &Type::singleton<result_type>();
				this->signature.addArgument(Name::declare(arg1name), Type::singleton<typename boost::function_traits<Signature>::arg1_type>());
				this->signature.addArgument(Name::declare(arg2name), Type::singleton<typename boost::function_traits<Signature>::arg2_type>());
			}
		public:
			virtual void setGenericCallback(DescribedBase* object, shared_ptr<SyncCallbackDescriptor::GenericFunction> function) const
			{
		...
		protected:
				...
				:SyncCallbackDesc<Signature>(classDescriptor, name, attributes, security)
			{
				...
				this->signature.addArgument(Name::declare(arg1name), Type::singleton<typename boost::function_traits<Signature>::arg1_type>());
				this->signature.addArgument(Name::declare(arg2name), Type::singleton<typename boost::function_traits<Signature>::arg2_type>());
				this->signature.addArgument(Name::declare(arg3name), Type::singleton<typename boost::function_traits<Signature>::arg3_type>());
			}
		public:
			virtual void setGenericCallback(DescribedBase* object, shared_ptr<SyncCallbackDescriptor::GenericFunction> function) const
			{
		...
		protected:
				...
				:SyncCallbackDesc<Signature>(classDescriptor, name, attributes, security)
			{
				...
				this->signature.addArgument(Name::declare(arg2name), Type::singleton<typename boost::function_traits<Signature>::arg2_type>());
				this->signature.addArgument(Name::declare(arg3name), Type::singleton<typename boost::function_traits<Signature>::arg3_type>());
				this->signature.addArgument(Name::declare(arg4name), Type::singleton<typename boost::function_traits<Signature>::arg4_type>());
			}
		public:
			virtual void setGenericCallback(DescribedBase* object, shared_ptr<SyncCallbackDescriptor::GenericFunction> function) const
			{
