...
namespace WBX
{
	...
	namespace Reflection
	{
		...
		*/
		...
		class WBXInterface GenericSlotWrapper 
			: boost::noncopyable
			, public wbx::Diagnostics::Countable< GenericSlotWrapper >
		{
		...
		class TGenericSlotWrapper 
				...
				, public wbx::Diagnostics::Countable< TGenericSlotWrapper<GenericSlot> >
		{
		...
		public:
			...
			{ 
				...
				{
					wbx::StandardOut::singleton()->printf(wbx::MESSAGE_ERROR, "Exception caught in TGenericSlotWrapper. %s", e.what());
				}
			} 
		};
		...
		*/
		...
		public:
			virtual wbx::signals::connection connectGeneric(EventSource* source, shared_ptr<GenericSlotWrapper> wrapper) const = 0;
		...
		public:
			inline wbx::signals::connection connect(EventSource* source, const boost::function<Signature>& slot) const
            {
				if (source)
				{
					...
					return wbx::signals::connection();		// return an empty connection
			}
		...
		protected:
			...
			{}
		public:
			wbx::signals::connection connectGeneric(EventSource* source, shared_ptr<GenericSlotWrapper> wrapper) const 
			{
				EventArguments foo2;
			...
			{
				WBX_SIGNALS_ASSERT(args.size() == 0);
				EventClass* e = boost::polymorphic_downcast<EventClass*>(source);
		...
		public:
			...
			inline void fireEvent(EventSource* source, const EventArguments& args) const
			{
				WBX_SIGNALS_ASSERT(args.size() == 1);
				EventClass* e = boost::polymorphic_downcast<EventClass*>(source);
				this->getSignal(e)(
		...
		public:
			...
			inline void fireEvent(EventSource* source, const EventArguments& args) const
			{
				WBX_SIGNALS_ASSERT(args.size() == 2);
				EventClass* e = boost::polymorphic_downcast<EventClass*>(source);
				this->getSignal(e)(
					args[0].cast<typename boost::function_traits<Signature>::arg1_type>(),
		...
		public:
			...
			inline void fireEvent(EventSource* source, const EventArguments& args) const
			{
				WBX_SIGNALS_ASSERT(args.size() == 3);
				EventClass* e = boost::polymorphic_downcast<EventClass*>(source);
				this->getSignal(e)(
					args[0].cast<typename boost::function_traits<Signature>::arg1_type>(),
					args[1].cast<typename boost::function_traits<Signature>::arg2_type>(),
		...
		public:
			...
			inline void fireEvent(EventSource* source, const EventArguments& args) const
			{
				WBX_SIGNALS_ASSERT(args.size() == 4);
				EventClass* e = boost::polymorphic_downcast<EventClass*>(source);
				this->getSignal(e)(
					args[0].cast<typename boost::function_traits<Signature>::arg1_type>(),
					args[1].cast<typename boost::function_traits<Signature>::arg2_type>(),
		...
		public:
			...
			inline void fireEvent(EventSource* source, const EventArguments& args) const
			{
				WBX_SIGNALS_ASSERT(args.size() == 5);
				EventClass* e = boost::polymorphic_downcast<EventClass*>(source);
				this->getSignal(e)(
                                   args[0].cast<typename boost::function_traits<Signature>::arg1_type>(),
                                   args[1].cast<typename boost::function_traits<Signature>::arg2_type>(),
		...
		public:
			...
			inline void fireEvent(EventSource* source, const EventArguments& args) const
			{
				WBX_SIGNALS_ASSERT(args.size() == 6);
				EventClass* e = boost::polymorphic_downcast<EventClass*>(source);
				this->getSignal(e)(
					args[0].cast<typename boost::function_traits<Signature>::arg1_type>(),
					args[1].cast<typename boost::function_traits<Signature>::arg2_type>(),
		...
		public:
			...
			inline void fireEvent(EventSource* source, const EventArguments& args) const
			{
				WBX_SIGNALS_ASSERT(args.size() == 7);
				EventClass* e = boost::polymorphic_downcast<EventClass*>(source);
				this->getSignal(e)(
					args[0].cast<typename boost::function_traits<Signature>::arg1_type>(),
					args[1].cast<typename boost::function_traits<Signature>::arg2_type>(),
		...
		template<
			...
			typename SignalType = wbx::signal<Signature>, // Optional specialization of the signal type
		...
		public:
				...
				:EventDescImpl<1, EventClass, Signature, SignalType, SignalGetter>(sig, name, security, attributes)
			{
				...
				SignatureDescriptor::Item arg1(&Name::declare(arg1name), &Type::singleton<typename boost::function_traits<Signature>::arg1_type>());
				...
				:EventDescImpl<2, EventClass, Signature, SignalType, SignalGetter>(sig, name, security, attributes)
			{
				...
				SignatureDescriptor::Item arg1(&Name::declare(arg1name), &Type::singleton<typename boost::function_traits<Signature>::arg1_type>());
				this->signature.arguments.push_back(arg1);
				SignatureDescriptor::Item arg2(&Name::declare(arg2name), &Type::singleton<typename boost::function_traits<Signature>::arg2_type>());
				...
				:EventDescImpl<3, EventClass, Signature, SignalType, SignalGetter>(sig, name, security, attributes)
			{
				...
				SignatureDescriptor::Item arg2(&Name::declare(arg2name), &Type::singleton<typename boost::function_traits<Signature>::arg2_type>());
				this->signature.arguments.push_back(arg2);
				SignatureDescriptor::Item arg3(&Name::declare(arg3name), &Type::singleton<typename boost::function_traits<Signature>::arg3_type>());
				...
				:EventDescImpl<4, EventClass, Signature, SignalType, SignalGetter>(sig, name, security, attributes)
			{
				...
				SignatureDescriptor::Item arg3(&Name::declare(arg3name), &Type::singleton<typename boost::function_traits<Signature>::arg3_type>());
				this->signature.arguments.push_back(arg3);
				SignatureDescriptor::Item arg4(&Name::declare(arg4name), &Type::singleton<typename boost::function_traits<Signature>::arg4_type>());
            ...
            :EventDescImpl<5, EventClass, Signature, SignalType, SignalGetter>(sig, name, security, attributes)
			{
				...
				SignatureDescriptor::Item arg4(&Name::declare(arg4name), &Type::singleton<typename boost::function_traits<Signature>::arg4_type>());
				this->signature.arguments.push_back(arg4);
                SignatureDescriptor::Item arg5(&Name::declare(arg5name), &Type::singleton<typename boost::function_traits<Signature>::arg5_type>());
				...
				:EventDescImpl<6, EventClass, Signature, SignalType, SignalGetter>(sig, name, security, attributes)
			{
				...
				SignatureDescriptor::Item arg5(&Name::declare(arg5name), &Type::singleton<typename boost::function_traits<Signature>::arg5_type>());
				this->signature.arguments.push_back(arg5);
				SignatureDescriptor::Item arg6(&Name::declare(arg6name), &Type::singleton<typename boost::function_traits<Signature>::arg6_type>());
				...
				:EventDescImpl<7, EventClass, Signature, SignalType, SignalGetter>(sig, name, security, attributes)
			{
				...
				SignatureDescriptor::Item arg6(&Name::declare(arg6name), &Type::singleton<typename boost::function_traits<Signature>::arg6_type>());
				this->signature.arguments.push_back(arg6);
				SignatureDescriptor::Item arg7(&Name::declare(arg7name), &Type::singleton<typename boost::function_traits<Signature>::arg7_type>());
		...
		template<
			class EventClass,	// The class type that fires the event
			typename Signature, // The signature of the event
			typename SignalType = wbx::remote_signal<Signature>, // Optional specialization of the signal type
			typename SignalGetter = SignalType EventClass::*  // Optional signal getter, raw member pointer by default
		>
