...
namespace WBX {
	...
	public:
		...
		// Network
		const wbx::SystemAddress getNetworkOwner() const {return networkOwner;}
		void setNetworkOwner(const wbx::SystemAddress value) {networkOwner = value;}
		...
		bool hitTest(const WBXRay& worldRay, Vector3& worldHitPoint, Vector3& surfaceNormal);
