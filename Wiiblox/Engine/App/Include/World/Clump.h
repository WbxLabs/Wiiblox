...
namespace WBX {
	...
	public:
		...
		Primitive* getClumpPrimitive()						{return WBX_static_cast<Primitive*>(getLower());}
		const Primitive* getConstClumpPrimitive() const		{return WBX_static_cast<const Primitive*>(getConstLower());}
