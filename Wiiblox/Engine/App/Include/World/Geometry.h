...
namespace WBX {
	...
	public:
		...
		// Hit Test
		virtual bool hitTest(const WBXRay& rayInMe, Vector3& localHitPoint, Vector3& surfaceNormal) {return false;}
		...
		virtual bool hitTestTerrain(const WBXRay& rayInMe, Vector3& localHitPoint, int& surfId, CoordinateFrame& surfCf) { return false; }
	};
