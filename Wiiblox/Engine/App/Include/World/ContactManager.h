...
namespace WBX {
		...
		public Voxel2::GridListener
	{
		...
		Primitive* getFastHit(	const WBXRay& worldRay,						// implies distance as well
	...
	public:
		...
		Primitive* getHit(	const WBXRay& worldRay, 
		...
		bool intersectingMySimulation(Primitive* check, wbx::SystemAddress myLocalAddress, float overlapIgnored);
		...
		void onNewPair(wbx::Graphics::CullableSceneNode* p0, wbx::Graphics::CullableSceneNode* p1) { RBXASSERT(0); } 

		void checkTerrainContact(Primitive* p);
        void checkTerrainContact(wbx::Graphics::CullableSceneNode* p0) {}

        bool primitiveIsExcludedFromSpatialHash(Primitive* p);
        bool primitiveIsExcludedFromSpatialHash(wbx::Graphics::CullableSceneNode* p0) {return false;}
		
		void releasePair(Primitive* p0, Primitive* p1);
		void releasePair(wbx::Graphics::CullableSceneNode* p0, wbx::Graphics::CullableSceneNode* p1) { RBXASSERT(0); }
		...
		/////////////////////////////////////////////
		// LEGACY
		Primitive* getHitLegacy(	const WBXRay& originDirection, 
