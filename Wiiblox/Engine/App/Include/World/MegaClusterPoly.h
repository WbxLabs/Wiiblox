...
namespace WBX {
	...
	private:
        ...
        bool hitLocationOnBlockCell(const WBXRay& rayInMe, const Vector3int16& testCell, Vector3& localHitPoint, Vector3& surfaceNormal, int& surfId, CoordinateFrame& surfaceCf) const;
        bool hitLocationOnVerticalWedgeCell(const WBXRay& rayInMe, const Vector3int16& testCell, const int& orientation, Vector3& localHitPoint, Vector3& surfaceNormal, CoordinateFrame& surfaceCf) const;
        bool hitLocationOnHorizontalWedgeCell(const WBXRay& rayInMe, const Vector3int16& testCell, const int& orientation, Vector3& localHitPoint, Vector3& surfaceNormal, CoordinateFrame& surfaceCf) const;
        bool hitLocationOnCornerWedgeCell(const WBXRay& rayInMe, const Vector3int16& testCell, const int& orientation, Vector3& localHitPoint, Vector3& surfaceNormal, CoordinateFrame& surfaceCf) const;
        bool hitLocationOnInverseCornerWedgeCell(const WBXRay& rayInMe, const Vector3int16& testCell, const int& orientation, Vector3& localHitPoint, Vector3& surfaceNormal, CoordinateFrame& surfaceCf) const;

        bool hitTestMC(const WBXRay& rayInMe, Vector3& localHitPoint, Vector3& surfaceNormal, int& surfId, CoordinateFrame& surfaceCf, float searchRayMax = MC_SEARCH_RAY_MAX, bool treatCellsAsBlocks = false, bool ignoreWater = false);
    ...
    public:
        /*override*/ bool hitTest(const WBXRay& rayInMe, Vector3& localHitPoint, Vector3& surfaceNormal, float searchRayMax = MC_SEARCH_RAY_MAX, bool treatCellsAsBlocks = false, bool ignoreWater = false);
		...
		virtual bool hitTestTerrain(const WBXRay& rayInMe, Vector3& localHitPoint, int& surfId, CoordinateFrame& surfCf);
