...
namespace WBX {
	...
	public:
		wbx::signal<void(Joint*, Primitive*, std::vector<Primitive*>&)> postInsertJointSignal;
		wbx::signal<void(Joint*, std::vector<Primitive*>&, std::vector<Primitive*>&)> postRemoveJointSignal;
		wbx::signal<void(Joint*)> autoJoinSignal;
		wbx::signal<void(Joint*)> autoDestroySignal;
		wbx::signal<void(std::pair<Primitive*, Primitive*>)> primitiveCollideSignal;
	...
	public:
		...
		wbx::Profiling::CodeProfiler& getProfileWorldStep() { return *profilingWorldStep; }
		const wbx::Profiling::CodeProfiler& getProfileWorldStep() const { return *profilingWorldStep; }

		void loadProfilers(std::vector<wbx::Profiling::CodeProfiler*>& worldProfilers) const;
