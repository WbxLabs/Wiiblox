	...
	namespace POLY {
		...
		*/
		...
		private:
			...
			bool rayIntersectsFace(const WBXRay& ray, const Face* face, Vector3& intersection) const;
		...
		public:
			...
			bool hitTest(const WBXRay& ray, Vector3& hitPoint, Vector3& surfaceNormal) const;
