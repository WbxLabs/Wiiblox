...
// error: 'static int wbx::Lua::Bridge<Class, __eq>::on_index(lua_State*) [with Class = wbx::Lua::EventInstance, bool __eq = true]' is protected
#ifdef _WIN32
protected:
#endif
...
public:
	...
	static boost::shared_ptr<Class> getPtr(lua_State *L, unsigned int index)
	{
		if (lua_isnil(L, index))
			...
			return wbx::Lua::Bridge<boost::shared_ptr<Class>, false>::getObject(L, index);
	}
