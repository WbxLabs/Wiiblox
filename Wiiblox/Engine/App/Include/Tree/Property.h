...
namespace WBX {
	...
	{
		wbx::Reflection::Property property;
	public:
		const wbx::Reflection::Property& getProperty() const { return property; }
		const wbx::Reflection::PropertyDescriptor& getDescriptor() const { return property.getDescriptor(); }
		const Name& getName() { return property.getName(); }
	...
	private:
		...
		PropertyChanged(const wbx::Reflection::Property& p) 
			: property(p)
		{}
	};
