...
static const Reflection::EnumPropDescriptor<GameBasicSettings, GameBasicSettings::CameraMode> prop_cameraMode("CameraMode", category_Control, &GameBasicSettings::getCameraMode, &GameBasicSettings::setCameraMode, Reflection::PropertyDescriptor::STANDARD, Security::WiibloxScript);
...
static const Reflection::PropDescriptor<GameBasicSettings, bool> prop_TouchCameraMovementChanged("TouchCameraMovementChanged",category_Data, &GameBasicSettings::getTouchCameraMovementModeModified,&GameBasicSettings::setTouchCameraMovementModeModified, Reflection::PropertyDescriptor::CLUSTER, Security::Wiiblox);
...
static const Reflection::PropDescriptor<GameBasicSettings, bool> prop_ComputerCameraMovementChanged("ComputerCameraMovementChanged",category_Data, &GameBasicSettings::getComputerCameraMovementModeModified,&GameBasicSettings::setComputerCameraMovementModeModified, Reflection::PropertyDescriptor::CLUSTER, Security::Wiiblox);
...
static const Reflection::PropDescriptor<GameBasicSettings, bool> prop_TouchMovementChanged("TouchMovementChanged",category_Data, &GameBasicSettings::getTouchMovementModeModified,&GameBasicSettings::setTouchMovementModeModified, Reflection::PropertyDescriptor::CLUSTER, Security::Wiiblox);
...
static const Reflection::PropDescriptor<GameBasicSettings, bool> prop_ComputerMovementChanged("ComputerMovementChanged",category_Data, &GameBasicSettings::getComputerMovementModeModified,&GameBasicSettings::setComputerMovementModeModified, Reflection::PropertyDescriptor::CLUSTER, Security::Wiiblox);
static const Reflection::EnumPropDescriptor<GameBasicSettings, GameSettings::UploadSetting> prop_uploadVideo("VideoUploadPromptBehavior", category_Video, &GameBasicSettings::getUploadVideoSetting, &GameBasicSettings::setUploadVideoSetting, Reflection::PropertyDescriptor::STANDARD, Security::WiibloxScript);
...
static Reflection::BoundFuncDesc<GameBasicSettings, bool(std::string)> func_getTutorialState(&GameBasicSettings::getTutorialState, "GetTutorialState", "tutorialId", Security::WiibloxScript);
static Reflection::BoundFuncDesc<GameBasicSettings, void(std::string, bool)> func_setTutorialState(&GameBasicSettings::setTutorialState, "SetTutorialState", "tutorialId", "value", Security::WiibloxScript);
static const Reflection::PropDescriptor<GameBasicSettings, std::string> prop_CompletedTutorials("CompletedTutorials",category_Data, &GameBasicSettings::getCompletedTutorials,&GameBasicSettings::setCompletedTutorials, Reflection::PropertyDescriptor::STREAMING, Security::WiibloxScript);
static const Reflection::PropDescriptor<GameBasicSettings, bool> prop_AllTutorialsDisabled("AllTutorialsDisabled",category_Data, &GameBasicSettings::getAllTutorialsDisabled,&GameBasicSettings::setAllTutorialsDisabled, Reflection::PropertyDescriptor::STANDARD, Security::WiibloxScript);

static Reflection::PropDescriptor<GameBasicSettings, bool> prop_startMaximized("StartMaximized",category_Data, &GameBasicSettings::getStartMaximized, &GameBasicSettings::setStartMaximized, Reflection::PropertyDescriptor::PUBLIC_SERIALIZED, Security::WiibloxScript);
static Reflection::PropDescriptor<GameBasicSettings, Vector2> prop_startScreenSize("StartScreenSize",category_Data, &GameBasicSettings::getStartScreenSize, &GameBasicSettings::setStartScreenSize, Reflection::PropertyDescriptor::PUBLIC_SERIALIZED, Security::WiibloxScript);
static Reflection::PropDescriptor<GameBasicSettings, Vector2> prop_startScreenPos("StartScreenPosition",category_Data, &GameBasicSettings::getStartScreenPos, &GameBasicSettings::setStartScreenPos, Reflection::PropertyDescriptor::PUBLIC_SERIALIZED, Security::WiibloxScript);
...
static const Reflection::PropDescriptor<GameBasicSettings, bool> prop_isFullscreen("Fullscreen",category_Data, &GameBasicSettings::getFullScreenConst, &GameBasicSettings::setFullScreen, Reflection::PropertyDescriptor::STANDARD, Security::WiibloxScript);
...
static const Reflection::EnumPropDescriptor<GameBasicSettings, GameSettings::UploadSetting> prop_uploadScreenshots("ImageUploadPromptBehavior", "Screenshots", &GameBasicSettings::getPostImageSetting, &GameBasicSettings::setPostImageSetting, Reflection::PropertyDescriptor::STANDARD, Security::WiibloxScript);
static Reflection::PropDescriptor<GameBasicSettings, std::string> prop_googleAnalyticsClientId("gaID", "Configuration", &GameBasicSettings::getGoogleAnalyticsClientId, &GameBasicSettings::setGoogleAnalyticsClientId, Reflection::PropertyDescriptor::CLUSTER, Security::WiibloxScript); // TODO: change CLUSTER to more generic name

static const Reflection::PropDescriptor<GameBasicSettings, bool> prop_usedHideHudShortcut("UsedHideHudShortcut",category_Data, &GameBasicSettings::getUsedHideHudShortcut, &GameBasicSettings::setUsedHideHudShortcut, Reflection::PropertyDescriptor::STANDARD, Security::WiibloxScript);
...
const char *const wbx::sGameBasicSettings = "UserGameSettings";
...
{
	try {
		wbx::Security::Context::current().requirePermission(wbx::Security::WiibloxScript, "set camera control mode");
	} 
	catch (wbx::base_exception& e) 
	{
		wbx::StandardOut::singleton()->printf(wbx::MESSAGE_ERROR, "Insufficient permissions to set ControlMode");
		throw e;
	}
...
#if defined(WBX_PLATFORM_IOS) || defined(__ANDROID__)
...
void GameBasicSettings::setCameraMode(CameraMode setting)
{
	if(cameraMode != setting)
	{
		...
		if ( WiibloxGoogleAnalytics::isInitialized() )
		{
			WiibloxGoogleAnalytics::trackEvent(GA_CATEGORY_GAME, "CustomCameraMode", label);
		}
...
{
	try {
		wbx::Security::Context::current().requirePermission(wbx::Security::WiibloxScript, "set camera movement mode for touch devices");
	} 
	catch (wbx::base_exception& e) 
	{
		wbx::StandardOut::singleton()->printf(wbx::MESSAGE_ERROR, "Insufficient permissions to set TouchCameraMovementMode");
		throw e;
	}
	...
	if(touchCameraMovementMode != setting)
	{
		...
		if (WiibloxGoogleAnalytics::isInitialized())
			WiibloxGoogleAnalytics::trackEvent(GA_CATEGORY_GAME, "TouchCameraMoveMode", label);
...
{
	try {
		wbx::Security::Context::current().requirePermission(wbx::Security::WiibloxScript, "set camera movement mode for computer devices");
	} 
	catch (wbx::base_exception& e) 
	{
		wbx::StandardOut::singleton()->printf(wbx::MESSAGE_ERROR, "Insufficient permissions to set ComputerCameraMovementMode");
		throw e;
	}
	...
	if(computerCameraMovementMode != setting)
	{
		...
		if (WiibloxGoogleAnalytics::isInitialized())
			WiibloxGoogleAnalytics::trackEvent(GA_CATEGORY_GAME, "ComputerCameraMoveMode", label);
...
{
	try {
		wbx::Security::Context::current().requirePermission(wbx::Security::WiibloxScript, "set character movement mode for touch devices");
	} 
	catch (wbx::base_exception& e) 
	{
		wbx::StandardOut::singleton()->printf(wbx::MESSAGE_ERROR, "Insufficient permissions to set TouchMovementMode");
		throw e;
	}
	...
	if(touchMoveMode != setting)
	{
		...
		if (WiibloxGoogleAnalytics::isInitialized())
			WiibloxGoogleAnalytics::trackEvent(GA_CATEGORY_GAME, "TouchMovementMode", label);
...
{
	try {
		wbx::Security::Context::current().requirePermission(wbx::Security::WiibloxScript, "set character movement mode for computer devices");
	} 
	catch (wbx::base_exception& e) 
	{
		wbx::StandardOut::singleton()->printf(wbx::MESSAGE_ERROR, "Insufficient permissions to set ComputerMovementMode");
		throw e;
	}
	...
	if(computerMoveMode != setting)
	{
		...
		if (WiibloxGoogleAnalytics::isInitialized())
			WiibloxGoogleAnalytics::trackEvent(GA_CATEGORY_GAME, "ComputerMovementMode", label);
...
wbx::GameBasicSettings::RotationType GameBasicSettings::getRotationType() const
{
	return rotationType;
}
...
{
	try {
		wbx::Security::Context::current().requirePermission(wbx::Security::WiibloxScript, "set render quality level");
	} 
	catch (wbx::base_exception& e) 
	{
		wbx::StandardOut::singleton()->printf(wbx::MESSAGE_ERROR, "Insufficient permissions to set SavedQualityLevel");
		throw e;
	}
...
{
	try {
		wbx::Security::Context::current().requirePermission(wbx::Security::WiibloxScript, "set master sound volume");
	} 
	catch (wbx::base_exception& e) 
	{
		wbx::StandardOut::singleton()->printf(wbx::MESSAGE_ERROR, "Insufficient permissions to set MasterVolume");
		throw e;
	}
...
{
	try {
		wbx::Security::Context::current().requirePermission(wbx::Security::WiibloxScript, "set mouse sensitivity");
	} 
	catch (wbx::base_exception& e) 
	{
		wbx::StandardOut::singleton()->printf(wbx::MESSAGE_ERROR, "Insufficient permissions to set MouseSensitivity");
		throw e;
	}
...
{
	if (wbx::Security::Context::current().identity != wbx::Security::Anonymous) 
	{
		try {
			wbx::Security::Context::current().requirePermission(wbx::Security::WiibloxScript, "set GameSettings parent");
		} 
		catch (wbx::base_exception& e) 
		{
			wbx::StandardOut::singleton()->printf(wbx::MESSAGE_ERROR, "Insufficient permissions to set GameSettings parent");
			throw e;
		}
	}
...
void GameBasicSettings::recordSettingsInGA(bool touchEnabled) const
{
	...
	if (touchEnabled) {
		...
		WiibloxGoogleAnalytics::trackEvent(GA_CATEGORY_GAME, "TouchCameraMove", CameraMovement);
		if (touchCameraMovementModeModified) {
			WiibloxGoogleAnalytics::trackEvent(GA_CATEGORY_GAME, "TouchCameraMoveModified", CameraMovement);
		}
		...
		WiibloxGoogleAnalytics::trackEvent(GA_CATEGORY_GAME, "TouchMovement", CharacterMovement);
		if (touchMoveModeModeModified) {
			WiibloxGoogleAnalytics::trackEvent(GA_CATEGORY_GAME, "TouchMovementModified", CharacterMovement);
		}
	} else {
		...
		WiibloxGoogleAnalytics::trackEvent(GA_CATEGORY_GAME, "ComputerCameraMove", CameraMovement);
		if (computerCameraMovementModeModified) {
			WiibloxGoogleAnalytics::trackEvent(GA_CATEGORY_GAME, "ComputerCameraMoveModified", CameraMovement);
		}
		...
		WiibloxGoogleAnalytics::trackEvent(GA_CATEGORY_GAME, "ComputerMovement", CharacterMovement);
		if (computerMoveModeModeModified) {
			WiibloxGoogleAnalytics::trackEvent(GA_CATEGORY_GAME, "ComputerMovementModified", CharacterMovement);
		}
	}
}
