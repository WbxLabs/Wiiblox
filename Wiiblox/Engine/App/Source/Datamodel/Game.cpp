...
namespace WBX {
	...
	{
		wbx::Http::CookieSharingPolicy cookieSharingPolicy;
#if defined(WBX_PLATFORM_IOS) || defined(__ANDROID__)
        cookieSharingPolicy = wbx::Http::CookieSharingSingleProcessMultipleThreads;
#elif defined(WBX_PLATFORM_DURANGO)
		cookieSharingPolicy = wbx::Http::CookieSharingSingleProcessMultipleThreads;
#elif defined(_WIN32) || defined(__APPLE__)
	if (DFFlag::PersistenceCurlCookies)
	{
        cookieSharingPolicy = wbx::Http::CookieSharingMultipleProcessesWrite;
        if (isStudio)
        {
            cookieSharingPolicy |= wbx::Http::CookieSharingMultipleProcessesRead;
        }
	}
	else
		cookieSharingPolicy = wbx::Http::CookieSharingSingleProcessMultipleThreads;
...
#error Unsupported platform.
    ...
    {        
		...
		wbx::GameBasicSettings::singleton().recordSettingsInGA(touchEnabled);
    }
	...
	void Game::configurePlayer(wbx::Security::Identities identity, const std::string& params, int launchMode, const char* vrDevice)
	{
