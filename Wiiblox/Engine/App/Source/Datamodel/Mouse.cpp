...
static Reflection::PropDescriptor<Mouse, wbx::WBXRay> desc_UnitRay("UnitRay", category_Data, &Mouse::getUnitRay, NULL);
...
wbx::WBXRay Mouse::getUnitRay() const
{
	checkActive();
...
int Mouse::getViewSizeX() const
{
	...
	if (GuiService* guiService = wbx::ServiceProvider::find<GuiService>(workspace))
	{
