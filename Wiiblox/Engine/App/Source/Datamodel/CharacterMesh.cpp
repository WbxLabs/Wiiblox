...
TextureId CharacterMesh::getBaseTextureId() const
{
	...
	{
		return TextureId(wbx::format("wbxassetid://%d", baseTextureAssetId));
	}
	else
	{
...
TextureId CharacterMesh::getOverlayTextureId() const
{
	...
	{
		return TextureId(wbx::format("wbxassetid://%d", overlayTextureAssetId));
	}
	else
	{
		return TextureId::nullTexture();
...
MeshId CharacterMesh::getMeshId() const
{
	if(meshAssetId != 0)
	{
		return MeshId(wbx::format("wbxassetid://%d", meshAssetId));
	}
	else
	{
		return MeshId();
