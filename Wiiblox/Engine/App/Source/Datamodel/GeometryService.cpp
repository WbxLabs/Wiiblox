...
const char* const wbx::sGeometryService = "Geometry";
...
static void addInstanceToIgnorePrimitiveSet(shared_ptr<wbx::Instance> instance, boost::unordered_set<const Primitive*>& primitiveSet)
{
...
Vector3 GeometryService::getHitLocationPartFilterDescendents(IgnoreType *ancestor, wbx::WBXRay ray, shared_ptr<PartInstance>& result, Vector3& surfaceNormal, PartMaterial& surfaceMaterial, bool terrainCellsAreCubes, bool ignoreWaterCells)
{
	WBXPROFILER_SCOPE("Physics", "getHitLocationPartFilterDescendents");
...
template Vector3 GeometryService::getHitLocationPartFilterDescendents<Instance>(Instance*, wbx::WBXRay, shared_ptr<PartInstance>&, Vector3&, PartMaterial&, bool, bool);
template Vector3 GeometryService::getHitLocationPartFilterDescendents<const Instances>(const Instances*, wbx::WBXRay, shared_ptr<PartInstance>&, Vector3&, PartMaterial&, bool, bool);

Vector3 GeometryService::getHitLocationFilterDescendents(Instance *ancestor, wbx::WBXRay ray, Primitive **hitPrim, Vector3& surfaceNormal, PartMaterial& surfaceMaterial, bool terrainCellsAreCubes, bool ignoreWaterCells)
{
...
Vector3 GeometryService::getHitLocationFilterDescendents(const Instances *ancestors, wbx::WBXRay ray, Primitive **hitPrim, Vector3& surfaceNormal, PartMaterial& surfaceMaterial, bool terrainCellsAreCubes,  bool ignoreWaterCells)
{
	if (!workspace) return Vector3::zero();
...
Vector3 GeometryService::getHitLocationFilterStairs(Instance *ancestor, wbx::WBXRay ray, Primitive **hitPrim)
{
	if (!workspace) return Vector3::zero();
