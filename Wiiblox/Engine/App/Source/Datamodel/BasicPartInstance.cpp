...
void FormFactorPart::setFormFactorUi(FormFactor value)
{
	...
	wbx::StandardOut::singleton()->printf(wbx::MESSAGE_WARNING,"FormFactor is deprecated. You should no longer use this property.");
...
void BasicPartInstance::setLegacyPartTypeUi(LegacyPartType _type)
{
    if (!hasThreeDimensionalSize()) {
		WBXASSERT(formFactor == PartInstance::SYMETRIC);
	}
