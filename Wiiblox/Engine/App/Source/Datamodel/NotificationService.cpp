...
namespace WBX
{
    ...
    func_ScheduleNotification( &NotificationService::scheduleNotification, "ScheduleNotification", "userId", "alertId", "alertMsg", "minutesToFire", Security::WiibloxPlace);
    
    static Reflection::BoundFuncDesc<NotificationService, void(int, int) >
    func_CancelNotification( &NotificationService::cancelNotification, "CancelNotification", "userId", "alertId", Security::WiibloxPlace);

    static Reflection::BoundFuncDesc<NotificationService, void(int) >
    func_CancelAllNotification( &NotificationService::cancelAllNotification, "CancelAllNotification", "userId", Security::WiibloxPlace);
    
    static Reflection::BoundYieldFuncDesc<NotificationService, shared_ptr<const Reflection::ValueArray>(int)> func_GetScheduledNotifications( &NotificationService::getScheduledNotifications, "GetScheduledNotifications", "userId", Security::WiibloxPlace);
    REFLECTION_END();
