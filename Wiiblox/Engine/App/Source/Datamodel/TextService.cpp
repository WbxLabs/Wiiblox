...
static Reflection::BoundFuncDesc<TextService, Vector2(std::string, int, TextService::Font, Vector2)> func_getTextSize(&TextService::getTextSize, "GetTextSize", "string", "fontSize", "font", "frameSize", Security::WiibloxScript);
...
void TextService::registerTypesetter(Font font, shared_ptr<wbx::Typesetter> typesetter)
{
	WBXASSERT(font < FONT_LAST);
