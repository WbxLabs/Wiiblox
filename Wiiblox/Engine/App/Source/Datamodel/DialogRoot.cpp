...
static Reflection::BoundFuncDesc<DialogRoot, void(shared_ptr<Instance>, shared_ptr<Instance>)>  func_signalDialogChoice(&DialogRoot::signalDialogChoice, "SignalDialogChoiceSelected", "player", "dialogChoice", Security::WiibloxScript);
...
DialogRoot::~DialogRoot() 
{
    ...
    {
        wbx::removeWriteBreakpoint(reinterpret_cast<uintptr_t>(&initialPrompt));
    }
#endif
}
...
void DialogRoot::setInitialPrompt(std::string value)
{
    ...
    {
        wbx::addWriteBreakpoint(reinterpret_cast<uintptr_t>(&initialPrompt));
    }
#endif
}
