...
void GuiBase2d::RecursiveRenderChildren(shared_ptr<wbx::Instance> instance, Adorn* adorn)
{
	if(wbx::GuiBase2d* guiBase = Instance::fastDynamicCast<wbx::GuiBase2d>(instance.get())){
...
static void ResizeChildren(shared_ptr<wbx::Instance> instance, const Rect2D& viewport, bool force)
{
	if(wbx::GuiBase2d* guiBase = Instance::fastDynamicCast<wbx::GuiBase2d>(instance.get())){
		guiBase->handleResize(viewport, force);
	} else if (wbx::Folder* f = Instance::fastDynamicCast<wbx::Folder>(instance.get())) {
