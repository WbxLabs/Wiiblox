...
namespace WBX
{
	...
	static Reflection::BoundFuncDesc<HapticService, void(InputObject::UserInputType, HapticService::VibrationMotor, shared_ptr<const wbx::Reflection::Tuple>)> func_setMotor(&HapticService::setMotor, "SetMotor", "inputType", "vibrationMotor", "vibrationValues", Security::None);
	static Reflection::BoundFuncDesc<HapticService, shared_ptr<const wbx::Reflection::Tuple>(InputObject::UserInputType, HapticService::VibrationMotor)> func_getMotor(&HapticService::getMotor, "GetMotor", "inputType", "vibrationMotor", Security::None);
	REFLECTION_END();
	...
	shared_ptr<const wbx::Reflection::Tuple> HapticService::getMotor(InputObject::UserInputType inputType, HapticService::VibrationMotor vibrationMotor)
	{
		...
		shared_ptr<const wbx::Reflection::Tuple> tuple(wbx::make_shared<Reflection::Tuple>());
		return tuple;
	}

	void HapticService::setMotor(InputObject::UserInputType inputType, HapticService::VibrationMotor vibrationMotor, shared_ptr<const wbx::Reflection::Tuple> args)
	{
		if (args && !args->values.empty())
		{
			if (inputType == InputObject::TYPE_NONE)
			{
				wbx::StandardOut::singleton()->printf(wbx::MESSAGE_ERROR, "Error in HapticService:SetMotor inputType is not a valid type");
				return;
			}
			if (vibrationMotor == MOTOR_NONE)
			{
				wbx::StandardOut::singleton()->printf(wbx::MESSAGE_ERROR, "Error in HapticService:SetMotor vibrationMotor is not a valid type");
				return;
			}
		...
		{
			wbx::StandardOut::singleton()->printf(wbx::MESSAGE_ERROR, "Error in HapticService:SetMotor no values found for vibration.");
		}
	}
