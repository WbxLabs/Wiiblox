...
void Surface::setSurfaceInput(wbx::LegacyController::InputType value) 
{
...
template<wbx::NormalId face, typename V, typename Get, typename Set>
...
template<wbx::NormalId face, typename V >
class SurfacePropDescriptor : public Reflection::TypedPropertyDescriptor<V>
{
public:
	template<typename Get, typename Set>
	SurfacePropDescriptor(const char* name, const char* category, Get get, Set set, wbx::Reflection::PropertyDescriptor::Functionality flags = wbx::Reflection::PropertyDescriptor::STANDARD, Security::Permissions security = Security::None)
...
public:
	...
	virtual bool setStringValue(Reflection::DescribedBase* instance, const wbx::Name& name) const
	{
		V value;
	...
	virtual void readValue(Reflection::DescribedBase* instance, const XmlElement* element, wbx::IReferenceBinder& binder) const
	{
		if (!element->isXsiNil()) {
...
//WBX_REGISTER_TYPE(wbx::SurfaceType);
