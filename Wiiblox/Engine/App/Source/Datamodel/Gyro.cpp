...
const char* const  wbx::sBodyMover = "BodyMover";
const char* const  wbx::sBodyPosition = "BodyPosition";
const char* const  wbx::sBodyVelocity = "BodyVelocity";
const char* const  wbx::sBodyGyro = "BodyGyro";
const char* const  wbx::sBodyAngularVelocity = "BodyAngularVelocity";
const char* const  wbx::sBodyForce = "BodyForce";
const char* const  wbx::sBodyThrust = "BodyThrust";
const char* const  wbx::sRocket = "RocketPropulsion";

WBX_REGISTER_CLASS(wbx::BodyGyro);
WBX_REGISTER_CLASS(wbx::BodyForce);
WBX_REGISTER_CLASS(wbx::BodyThrust);
WBX_REGISTER_CLASS(wbx::BodyPosition);
WBX_REGISTER_CLASS(wbx::BodyVelocity);
WBX_REGISTER_CLASS(wbx::BodyAngularVelocity);
WBX_REGISTER_CLASS(wbx::Rocket);


static const float PGSSolverSpringConstantScale = 1.0f/19.0f;

void wbx::registerBodyMovers()
{
	BodyGyro::className();
...
void BodyMover::computeForce(bool throttling)
{
	WBXASSERT(world);
	WBXASSERT(part.lock());
	WBXASSERT(part.lock()->getPartPrimitive()->getBody());
//	WBXASSERT(part.lock()->getPrimitive()->getAssembly()->inKernel());
...
{
	WBXASSERT(Math::fuzzyEq(Vector3(1,1,1), Vector3(1.04,1,1), 0.05f));
	WBXASSERT(!Math::fuzzyEq(Vector3(1,1,1), Vector3(1.2,1,1), 0.05f));
...
bool BodyMover::duplicateBodyMoverExists(Primitive* p0, Primitive* p1)
{
	...
	do
	{
		...
		{
			//WBXASSERT(0);	// show to DB, then delete
			return true;
		}
		pairId++;
	}
...
wbx::Reflection::BoundFuncDesc<BodyPosition, G3D::Vector3()> func_getLastForce(&BodyPosition::getLastForce, "GetLastForce", Security::None);
wbx::Reflection::BoundFuncDesc<BodyPosition, G3D::Vector3()> func_getLastForceOld(&BodyPosition::getLastForce, "lastForce", Security::None, Reflection::PropertyDescriptor::Attributes::deprecated(func_getLastForce));
...
// Query for debugging:
// TODO: Can we fix Reflection to allow const member functions???
wbx::Reflection::BoundFuncDesc<BodyVelocity, G3D::Vector3()> func_getLastForceVOld(&BodyVelocity::getLastForce, "lastForce", Security::None);
wbx::Reflection::BoundFuncDesc<BodyVelocity, G3D::Vector3()> func_getLastForceV(&BodyVelocity::getLastForce, "GetLastForce", Security::None);
