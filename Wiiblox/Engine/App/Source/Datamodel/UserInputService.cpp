...
namespace WBX {
    ...
    wbx::Color3 UserInputService::DrawTouchColor = wbx::Color3(1,0,0);
    wbx::Color3 UserInputService::DrawMoveColor = wbx::Color3(0,1,0);
    
    REFLECTION_BEGIN();
	// Wiiblox Only functions/events/props
	static Reflection::BoundFuncDesc<UserInputService, UserInputService::Platform(void)> func_getPlatform(&UserInputService::getPlatformLua, "GetPlatform", Security::WiibloxScript);
    ...
    static Reflection::EventDesc<UserInputService, void(shared_ptr<const Reflection::ValueArray>, wbx::Vector2,wbx::Vector2,InputObject::UserInputState, bool)> event_PanGesture(&UserInputService::panGestureEvent, "TouchPan", "touchPositions", "totalTranslation", "velocity", "state", "gameProcessedEvent", Security::None);
    
    // Low Level touch events
	static Reflection::EventDesc<UserInputService, 
		void(shared_ptr<Instance>, bool), 
		wbx::signal<void(shared_ptr<Instance>, bool)>,
		wbx::signal<void(shared_ptr<Instance>, bool)>* (UserInputService::*)(bool)> event_TouchStarted(&UserInputService::getTouchBeganEvent, "TouchStarted", "touch", "gameProcessedEvent", Security::None);
	static Reflection::EventDesc<UserInputService, 
		void(shared_ptr<Instance>, bool), 
		wbx::signal<void(shared_ptr<Instance>, bool)>,
		wbx::signal<void(shared_ptr<Instance>, bool)>* (UserInputService::*)(bool)>  event_TouchMoved(&UserInputService::getTouchChangedEvent, "TouchMoved", "touch", "gameProcessedEvent", Security::None);
	static Reflection::EventDesc<UserInputService, 
		void(shared_ptr<Instance>, bool), 
		wbx::signal<void(shared_ptr<Instance>, bool)>,
		wbx::signal<void(shared_ptr<Instance>, bool)>* (UserInputService::*)(bool)>  event_TouchEnded(&UserInputService::getTouchEndedEvent, "TouchEnded", "touch", "gameProcessedEvent", Security::None);

	// Low Level Generic input events
	Reflection::EventDesc<UserInputService, 
		void(shared_ptr<Instance>, bool), 
		wbx::signal<void(shared_ptr<Instance>, bool)>,
		wbx::signal<void(shared_ptr<Instance>, bool)>* (UserInputService::*)(bool)> UserInputService::event_InputBegin(&UserInputService::getInputBeganEvent, "InputBegan", "input", "gameProcessedEvent", Security::None);
	Reflection::EventDesc<UserInputService, 
		void(shared_ptr<Instance>, bool), 
		wbx::signal<void(shared_ptr<Instance>, bool)>,
		wbx::signal<void(shared_ptr<Instance>, bool)>* (UserInputService::*)(bool)> UserInputService::event_InputUpdate(&UserInputService::getInputChangedEvent, "InputChanged", "input", "gameProcessedEvent", Security::None);
	Reflection::EventDesc<UserInputService, 
		void(shared_ptr<Instance>, bool), 
		wbx::signal<void(shared_ptr<Instance>, bool)>,
		wbx::signal<void(shared_ptr<Instance>, bool)>* (UserInputService::*)(bool)> UserInputService::event_InputEnd(&UserInputService::getInputEndedEvent, "InputEnded", "input", "gameProcessedEvent", Security::None);
	...
	static Reflection::BoundFuncDesc<UserInputService, bool(wbx::KeyCode)> func_isKeyCodeDown(&UserInputService::isKeyDown, "IsKeyDown", "keyCode", Security::None);

    // Motion Stuff
    static Reflection::EventDesc<UserInputService,
        void(shared_ptr<Instance>),
        wbx::signal<void(shared_ptr<Instance>)>,
        wbx::signal<void(shared_ptr<Instance>)>* (UserInputService::*)(bool)> event_AccelerometerChanged(&UserInputService::getOrCreateScriptAccelerometerEventSignal, "DeviceAccelerationChanged","acceleration", Security::None);
    static Reflection::EventDesc<UserInputService,
            void(shared_ptr<Instance>),
            wbx::signal<void(shared_ptr<Instance>)>,
            wbx::signal<void(shared_ptr<Instance>)>* (UserInputService::*)(bool)> event_gravityChanged(&UserInputService::getOrCreateScriptGravityEventSignal, "DeviceGravityChanged","gravity", Security::None);
    static Reflection::EventDesc<UserInputService,
        void(shared_ptr<Instance>, CoordinateFrame),
        wbx::signal<void(shared_ptr<Instance>, CoordinateFrame)>,
        wbx::signal<void(shared_ptr<Instance>, CoordinateFrame)>* (UserInputService::*)(bool)> event_GyroChanged(&UserInputService::getOrCreateScriptGyroEventSignal, "DeviceRotationChanged","rotation","cframe", Security::None);
	...
	static Reflection::BoundFuncDesc<UserInputService, bool(InputObject::UserInputType, wbx::KeyCode)> func_getgamepadSupportsKeyCode(&UserInputService::gamepadSupports, "GamepadSupports", "gamepadNum", "gamepadKeyCode", Security::None);
    ...
    void UserInputService::onServiceProvider(ServiceProvider* oldProvider, ServiceProvider* newProvider)
    {
        ...
        if (newProvider)
        {
            if(DrawTouchEvents)
            {
               drawTouchFrame = Creatable<Instance>::create<wbx::Frame>();
               drawTouchFrame->setBorderSizePixel(0);
               drawTouchFrame->setSize(wbx::UDim2(0,4,0,4));
            }
            ...
            rotationInputObject = wbx::Creatable<Instance>::create<InputObject>(InputObject::TYPE_GYRO, InputObject::INPUT_STATE_CHANGE, Vector3(0,0,0), SDLK_UNKNOWN, wbx::DataModel::get(newProvider));
            accelerationInputObject = wbx::Creatable<Instance>::create<InputObject>(InputObject::TYPE_ACCELEROMETER, InputObject::INPUT_STATE_CHANGE, Vector3(0,0,0), SDLK_UNKNOWN, wbx::DataModel::get(newProvider));
            gravityInputObject = wbx::Creatable<Instance>::create<InputObject>(InputObject::TYPE_ACCELEROMETER, InputObject::INPUT_STATE_CHANGE, Vector3(0,0,0), SDLK_UNKNOWN, wbx::DataModel::get(newProvider));
            ...
            fakeMouseEventsMap[InputObject::TYPE_MOUSEMOVEMENT] = wbx::Creatable<wbx::Instance>::create<wbx::InputObject>(wbx::InputObject::TYPE_MOUSEMOVEMENT,
                                                                                                            wbx::InputObject::INPUT_STATE_CHANGE,
                                                                                                            wbx::Vector3(-1,-1,0),
                                                                                                            wbx::Vector3(0,0,0),
																											wbx::DataModel::get(newProvider));
            fakeMouseEventsMap[InputObject::TYPE_MOUSEMOVEMENT]->setSourceUserInputType(wbx::InputObject::TYPE_TOUCH);

            fakeMouseEventsMap[InputObject::TYPE_MOUSEBUTTON1] = wbx::Creatable<wbx::Instance>::create<wbx::InputObject>(wbx::InputObject::TYPE_MOUSEBUTTON1,
                                                                                                            wbx::InputObject::INPUT_STATE_BEGIN,
                                                                                                            wbx::Vector3(-1,-1,0),
                                                                                                            wbx::Vector3(0,0,0),
																											wbx::DataModel::get(newProvider));
            fakeMouseEventsMap[InputObject::TYPE_MOUSEBUTTON1]->setSourceUserInputType(wbx::InputObject::TYPE_TOUCH);

			currentMousePosition = wbx::Creatable<Instance>::create<InputObject>(InputObject::TYPE_MOUSEMOVEMENT, InputObject::INPUT_STATE_CANCEL, Vector3(-10000,-10000,0), SDLK_UNKNOWN, wbx::DataModel::get(newProvider));
        }
    }
	...
	wbx::signal<void(shared_ptr<Instance>, bool)>* UserInputService::getInputBeganEvent(bool whatever)
	{
		return wbx::Security::Context::current().hasPermission(wbx::Security::WiibloxScript) ? &coreInputBeganEvent : &inputBeganEvent;
	}
	wbx::signal<void(shared_ptr<Instance>, bool)>* UserInputService::getInputChangedEvent(bool whatever)
	{
		return wbx::Security::Context::current().hasPermission(wbx::Security::WiibloxScript) ? &coreInputUpdatedEvent : &inputUpdatedEvent;
	}
	wbx::signal<void(shared_ptr<Instance>, bool)>* UserInputService::getInputEndedEvent(bool whatever)
	{
		return wbx::Security::Context::current().hasPermission(wbx::Security::WiibloxScript) ? &coreInputEndedEvent : &inputEndedEvent;
	}

	wbx::signal<void(shared_ptr<Instance>, bool)>* UserInputService::getTouchBeganEvent(bool whatever)
	{
		return wbx::Security::Context::current().hasPermission(wbx::Security::WiibloxScript) ? &coreTouchStartedEvent : &touchStartedEvent;
	}
	wbx::signal<void(shared_ptr<Instance>, bool)>* UserInputService::getTouchChangedEvent(bool whatever)
	{
		return wbx::Security::Context::current().hasPermission(wbx::Security::WiibloxScript) ? &coreTouchMovedEvent : &touchMovedEvent;
	}
	wbx::signal<void(shared_ptr<Instance>, bool)>* UserInputService::getTouchEndedEvent(bool whatever)
	{
		return wbx::Security::Context::current().hasPermission(wbx::Security::WiibloxScript) ? &coreTouchEndedEvent : &touchEndedEvent;
	}
    
    UserInputService::Platform UserInputService::getPlatform()
    {
#if defined(WBX_PLATFORM_IOS)
        return PLATFORM_IOS;
#elif defined(__APPLE__) && !defined(WBX_PLATFORM_IOS)
        return PLATFORM_OSX;
#elif defined(WBX_PLATFORM_DURANGO)
		return PLATFORM_XBOXONE;
#elif defined(WBX_PLATFORM_UWP)
		if (isUWPWindowsPhone())
			return PLATFORM_ANDROID;
		return PLATFORM_UWP;
#elif defined(WBX_PLATFORM_DURANGO)
		return PLATFORM_XBOXONE;
#elif defined(_WIN32) && !defined(WBX_PLATFORM_DURANGO) && !defined(WBX_PLATFORM_UWP)
    ...
    void UserInputService::doDataModelProcessInput(DataModel* dataModel, const shared_ptr<InputObject>& inputObject, void* nativeInputObject, const InputObject::UserInputState& inputState)
    {
		...
		if (GuiService* guiService = wbx::ServiceProvider::find<GuiService>(dataModel))
		{
	...
	void UserInputService::updateCurrentMousePosition(const shared_ptr<InputObject>& inputObject)
	{
		...
		{
			if (Workspace* workspace = wbx::ServiceProvider::find<Workspace>(this))
			{
				Vector2 viewport = workspace->getCamera()->getViewport();
				Vector3 mousePos(viewport.x/2.0f,viewport.y/2.0f,0);

				if (wbx::Network::Players::findLocalPlayer(this))
				{
					DataModel* dataModel = DataModel::get(this);
					if (wbx::Workspace* workspace = dataModel->getWorkspace())
					{
				...
				currentMousePosition = wbx::Creatable<wbx::Instance>::create<wbx::InputObject>(InputObject::TYPE_MOUSEMOVEMENT, InputObject::INPUT_STATE_CHANGE,
					mousePos, Vector3::zero(), wbx::DataModel::get(this));
			}
		}
	}
    ...
    void UserInputService::processInputVector(EventsVector& eventVector, const InputObject::UserInputState& inputState)
    {
        ...
        if (tmpEventsVector.size() > 0)
        {
            ...
            for (EventsVector::iterator iter = begin; iter != end; ++iter)
            {
                if(DrawTouchEvents)
                {
                    shared_ptr<Instance> newObj = drawTouchFrame->clone(wbx::ScriptingCreator);
                    ...
                    {
                        if (Instance* parent = cgs->findFirstChildByName("WiibloxGui"))
                        {
    ...
    {
        DrawTouchColor = wbx::Color3(1,0,0);
        ...
        DrawTouchColor = wbx::Color3(0,0,1);
    ...
    void UserInputService::processCameraInternal()
    {
        ...
        if (FFlag::UserAllCamerasInLua)
        {
            ...
            {
                if (const wbx::Workspace* workspace = dataModel->getWorkspace())
                {
        ...
        if (DataModel* dataModel = DataModel::get(this))
        {
			wbx::Workspace* workspace = dataModel->getWorkspace();
			if(!workspace)
				return;
			...
			if (FFlag::FlyCamOnRenderStep)
			{
				if (!wbx::Network::Players::findLocalCharacter(this) || wbx::Network::Players::isCloudEdit(this))
				{
			...
			if( camera->getCameraType() == Camera::CUSTOM_CAMERA &&
				wbx::Network::Players::findLocalPlayer(dataModel) && !wbx::Network::Players::isCloudEdit(this))
			{
				cameraZoom = 0; 
				cameraPanDelta = Vector2::zero();
				cameraMouseWrap = Vector2::zero();
    ...
    void UserInputService::processToolEvents()
    {
        ...
        {
            if(wbx::DataModel* dataModel = wbx::DataModel::get(this))
            {
    ...
    void UserInputService::processTextboxInternal()
    {
        ...
        if (tmpTextboxEventsVector.size() > 0)
        {
            ...
            {
				shared_ptr<InputObject> dummyReturnInput = wbx::Creatable<Instance>::create<InputObject>(InputObject::TYPE_KEYBOARD, InputObject::INPUT_STATE_BEGIN, Vector3::zero(), SDLK_RETURN, wbx::DataModel::get(this));
	...
	shared_ptr<Instance> UserInputService::getFocusedTextBox()
	{
		if (!DFFlag::GetFocusedTextBoxEnabled)
		{
			wbx::StandardOut::singleton()->printf(MESSAGE_ERROR, "UserInputService:GetFocusedTextBox() is not yet enabled");
    ...
    void UserInputService::setLocalHumanoidJump(weak_ptr<DataModel> weakDataModel, bool isJump)
    {
        if(shared_ptr<DataModel> dataModel = weakDataModel.lock())
        {
            ...
            wbx::ModelInstance* localCharacter = wbx::Network::Players::findLocalCharacter(workspace);
            if(wbx::Humanoid* localHumanoid = wbx::Humanoid::modelIsCharacter(localCharacter))
    ...
    void UserInputService::moveLocalCharacterInternal(weak_ptr<DataModel> weakDataModel, Vector2 walkDir, float walkDelta)
    {
        if(shared_ptr<DataModel> dataModel = weakDataModel.lock())
        {
            ...
            if(wbx::Humanoid* localHumanoid = wbx::Humanoid::modelIsCharacter(localCharacter))
            {
                ...
                wbx::Vector2 northDirection(0,-1);
                ...
                wbx::Vector3 camLookVector = (camera->getCameraFocus().translation - camera->getCameraCoordinateFrame().translation).unit();
                wbx::Vector3 camLookProjected = G3D::Plane(Vector3(0,1,0),Vector3(0,0,0)).closestPoint(camLookVector);
                wbx::Vector2 camLook2d = wbx::Vector2(camLookProjected.x,camLookProjected.z);
                ...
                localHumanoid->setWalkDirection(wbx::Vector3(xRotated,0,zRotated));
            }
        }
    }
    ...
    void UserInputService::moveLocalCharacterLua(Vector2 walkDir, float maxWalkDelta)
    {
        ...
        moveLocalCharacterInternal(shared_from(wbx::DataModel::get(this)), walkDir, maxWalkDelta);
    }
    
    void UserInputService::moveLocalCharacter(wbx::Vector2 movementVector, float maxMovementDelta)
    {
    ...
    void UserInputService::processToolEvent(const shared_ptr<wbx::InputObject>& event)
    {
		boost::mutex::scoped_lock lock(ToolEventsMutex);
	...
	void UserInputService::wrapCamera(wbx::Vector2 mouseWrap)
	{
		cameraMouseWrap += mouseWrap;
	}
    
    void UserInputService::rotateCamera(wbx::Vector2 mouseDelta)
    {
		cameraPanDelta += mouseDelta;
		cameraPanDelta = Vector2(G3D::clamp(cameraPanDelta.x,-100.0f,100.0f),cameraPanDelta.y);
    }
    
    void UserInputService::rotateCameraLua(wbx::Vector2 mouseDelta)
    {
	...
	void UserInputService::mouseTrackCamera(wbx::Vector2 mouseDelta)
	{
        ...
        else if (boost::iequals(text, "console"))
        {
            if (CoreGuiService* cgs = dataModel->find<CoreGuiService>())
            {
                if (Instance* parent = cgs->findFirstChildByName("WiibloxGui"))
                {
                    ...
                    {
                        toggle->invoke(wbx::make_shared<Reflection::Tuple>(), 
    ...
    void UserInputService::addGestureEventToProcess(const UserInputService::Gesture gesture, shared_ptr<wbx::Reflection::ValueArray>& touchPositions, shared_ptr<Reflection::Tuple>& args)
    {
        if(touchPositions && args)
        {
            boost::mutex::scoped_lock lock(GestureEventsMutex);
            
            gestureEventsToProcess.push_back(std::pair<UserInputService::Gesture, std::pair<shared_ptr<wbx::Reflection::ValueArray>,shared_ptr<const Reflection::Tuple> > >(gesture, std::pair<shared_ptr<wbx::Reflection::ValueArray>, shared_ptr<const Reflection::Tuple> >(touchPositions, args)));
        }
    }
    
    void UserInputService::fireGestureEvent(const UserInputService::Gesture gesture, const shared_ptr<const wbx::Reflection::ValueArray>& touchPositions, const shared_ptr<const Reflection::Tuple>& args, const bool wasSunk)
    {
        switch (gesture)
        {
            ...
            case UserInputService::GESTURE_PAN:
                WBXASSERT(args->values.size() == 3);
                panGestureEvent(touchPositions,args->values[0].cast<wbx::Vector2>(),args->values[1].cast<wbx::Vector2>(),args->values[2].cast<InputObject::UserInputState>(), wasSunk);
                break;
    ...
    void UserInputService::processGestures()
    {
        ...
        if (tmpGestureEventsMap.size() > 0)
        {
            ...
            for (GestureEventsVector::iterator iter = tmpGestureEventsMap.begin(); iter != tmpGestureEventsMap.end(); ++iter)
            {
				...
				shared_ptr<wbx::Reflection::ValueArray> touchPositions = (*iter).second.first;

				if (guiOffset != Vector2::zero())
				{
					for (wbx::Reflection::ValueArray::iterator valueIter = touchPositions->begin(); valueIter != touchPositions->end(); ++valueIter)
					{
						if ((*valueIter).isType<wbx::Vector2>())
						{
							wbx::Vector2 touchPosition = (*valueIter).cast<wbx::Vector2>();
							...
							if (inputObject->getUserInputType() == InputObject::TYPE_MOUSEMOVEMENT)
							{
								...
								if (!processed)									
								{
									...
									if (mouseEventObject)
									{
										...
										mouseEventObject = wbx::Creatable<wbx::Instance>::create<wbx::InputObject>(inputObject->getUserInputType(), inputObject->getUserInputState(), 
    ...
    void UserInputService::fireAccelerationEvent(const wbx::Vector3& newAcceleration)
    {
    ...
    void UserInputService::fireGravityEvent(const wbx::Vector3& newGravity)
    {
        boost::mutex::scoped_lock lock(MotionEventsMutex);
    ...
    void UserInputService::fireRotationEvent(const wbx::Vector3& newRotation, const wbx::Vector4& quaternion)
    {
        boost::mutex::scoped_lock lock(MotionEventsMutex);
    ...
    wbx::signal<void(shared_ptr<Instance>, CoordinateFrame)>* UserInputService::getOrCreateScriptGyroEventSignal(bool create)
    {
        if (create)
        {
            ...
            {
                wbx::StandardOut::singleton()->printf(MESSAGE_WARNING, "Trying to listen to rotation events on a device without a gyroscope.");
            }
            else
            {
    ...
    wbx::signal<void(shared_ptr<Instance>)>* UserInputService::getOrCreateScriptGravityEventSignal(bool create )
    {
        if (create)
        {
            if (!Network::Players::frontendProcessing(this))
            ...
            {
                wbx::StandardOut::singleton()->printf(MESSAGE_WARNING, "Trying to listen to acceleration events on a device without a accelerometer.");
            }
            else
            {
    ...
    wbx::signal<void(shared_ptr<Instance>)>* UserInputService::getOrCreateScriptAccelerometerEventSignal(bool create )
    {
        if (create)
        {
            if (!Network::Players::frontendProcessing(this))
	...
	//////////////////////////////////////////////////////////////////////////
    void UserInputService::sendMouseEvent(const shared_ptr<wbx::InputObject>& event, void* nativeEventObject)
    {
...
#if defined(_WIN32) && !defined(WBX_PLATFORM_DURANGO) && !defined(WBX_PLATFORM_UWP)
    ...
    std::vector<wbx::ModCode> UserInputService::getCommandModCodes()
    {
        std::vector<wbx::ModCode> modCodes;
#ifdef _WIN32
	...
	wbx::ModCode UserInputService::getCurrentModKey()
	{
		for(std::vector<std::pair<wbx::KeyCode, wbx::ModCode> >::iterator it = modPairs.begin(); it != modPairs.end(); ++it)
        {
	...
	char UserInputService::getModifiedKey(wbx::KeyCode key, wbx::ModCode mod)
	{
		// if our keycode is actually a modifier, don't return a char
		switch(key)
		{
		case wbx::SDLK_LSHIFT:
		case wbx::SDLK_RSHIFT:
		case wbx::SDLK_LCTRL:
		case wbx::SDLK_RCTRL:
		case wbx::SDLK_CAPSLOCK:
		case wbx::SDLK_LALT:
		case wbx::SDLK_RALT:
			return 0;
		default:
		...
		bool shift = ((mod & wbx::KMOD_RSHIFT) != 0) || ((mod & wbx::KMOD_LSHIFT) != 0);
		bool caps = ((mod & wbx::KMOD_CAPS) != 0);

		//XOR
		bool isUpper = (shift && !caps) || (!shift && caps);

		if ((key >= wbx::SDLK_a) && (key <= wbx::SDLK_z)) 
		{
			if (isUpper) 
			{
				return 'A' + (key - wbx::SDLK_a);
			}
			else
			{	
				return 'a' + (key - wbx::SDLK_a);
		...
		if ((key >= wbx::SDLK_SPACE) && (key <= wbx::SDLK_AT)) {
			if(shift)
			{
				switch(key)
				{
				case wbx::SDLK_1:
					return wbx::SDLK_EXCLAIM;
					break;
				case wbx::SDLK_2:
					return wbx::SDLK_AT;
					break;
				case wbx::SDLK_3:
					return wbx::SDLK_HASH;
					break;
				case wbx::SDLK_4:
					return wbx::SDLK_DOLLAR;
					break;
				case wbx::SDLK_5:
					return wbx::SDLK_PERCENT;
					break;
				case wbx::SDLK_6:
					return wbx::SDLK_CARET;
					break;
				case wbx::SDLK_7:
					return wbx::SDLK_AMPERSAND;
					break;
				case wbx::SDLK_8:
					return wbx::SDLK_ASTERISK;
					break;
				case wbx::SDLK_9:
					return wbx::SDLK_LEFTPAREN;
					break;
				case wbx::SDLK_0:
					return wbx::SDLK_RIGHTPAREN;
					break;
                default:
                    break;
				}
		...
		if(shift)
		{
			switch(key)
			{
			case wbx::SDLK_SEMICOLON:
				return wbx::SDLK_COLON;
				break;
			case wbx::SDLK_COMMA:
				return wbx::SDLK_LESS;
				break;
			case wbx::SDLK_PERIOD:
				return wbx::SDLK_GREATER;
				break;
			case wbx::SDLK_SLASH:
				return wbx::SDLK_QUESTION;
				break;
			case wbx::SDLK_MINUS:
				return wbx::SDLK_UNDERSCORE;
				break;
			case wbx::SDLK_BACKQUOTE:
				return wbx::SDLK_TILDE;
				break;
			case wbx::SDLK_LEFTBRACKET:
				return wbx::SDLK_LEFTCURLY;
				break;
			case wbx::SDLK_RIGHTBRACKET:
				return wbx::SDLK_RIGHTCURLY;
				break;
			case wbx::SDLK_BACKSLASH:
				return wbx::SDLK_PIPE;
				break;
			case wbx::SDLK_EQUALS:
				return wbx::SDLK_PLUS;
				break;
			case wbx::SDLK_QUOTE:
				return wbx::SDLK_QUOTEDBL;
				break;
            default:
                break;
			}
	...
	void UserInputService::setKeyStateInternal(wbx::KeyCode keyCode, ModCode modCode, char modifiedKey, bool isDown) 
	{
		...
		{
			newKeyState[keyCode] = wbx::Creatable<Instance>::create<InputObject>(InputObject::TYPE_KEYBOARD,
	...
	void UserInputService::setKeyState(wbx::KeyCode keyCode, ModCode modCode, char modifiedKey, bool isDown) 
	{
        KeyboardData data;
	...
	bool UserInputService::isKeyDown(wbx::KeyCode keyCode) 
	{
        boost::unordered_map<wbx::KeyCode, shared_ptr<InputObject> >::iterator iter = newKeyState.find(keyCode);
	...
	{
		shared_ptr<Reflection::ValueArray> keyboardArray = wbx::make_shared<Reflection::ValueArray>();

		for (boost::unordered_map<wbx::KeyCode, shared_ptr<InputObject> >::iterator iter = newKeyState.begin(); iter != newKeyState.end(); ++iter)
		{
   ...
   ///////////////////////////////////////////////////////////////////////////
	...
	{
		shared_ptr<Reflection::ValueArray> gamepadConnectedArray = wbx::make_shared<Reflection::ValueArray>();
	...
	bool UserInputService::gamepadSupports(InputObject::UserInputType gamepadType, wbx::KeyCode keyCode)
	{
		...
		if (gamepadKeyCodes)
		{
			for (Reflection::ValueArray::const_iterator iter = gamepadKeyCodes->begin(); iter != gamepadKeyCodes->end(); ++iter)
			{
				...
				if (iterVariant.isType<wbx::KeyCode>())
				{
					wbx::KeyCode iterKeyCode = iterVariant.cast<wbx::KeyCode>();
	...
	{
		shared_ptr<Reflection::ValueArray> gamepadArray = wbx::make_shared<Reflection::ValueArray>();

		if (GamepadService* gamepadService = ServiceProvider::create<wbx::GamepadService>(this))
		{
	...
	{
		shared_ptr<Reflection::ValueArray> gamepadNavigationArray = wbx::make_shared<Reflection::ValueArray>();
		if (GamepadService* gamepadService = ServiceProvider::create<wbx::GamepadService>(this))
		{
