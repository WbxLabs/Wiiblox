...
namespace WBX
{
    ...
    REFLECTION_BEGIN();
	// backend
	static Reflection::BoundFuncDesc<MarketplaceService, void(int, int, bool)> func_signalPromptProductFinished(&MarketplaceService::signalPromptProductPurchaseFinished, "SignalPromptProductPurchaseFinished", "userId", "productId", "success", Security::WiibloxScript);
	static Reflection::BoundFuncDesc<MarketplaceService, void(shared_ptr<Instance>, int, bool)> func_signalPromptPurchaseFinished(&MarketplaceService::signalPromptPurchaseFinished, "SignalPromptPurchaseFinished", "player", "assetId", "success", Security::WiibloxScript);

	static Reflection::RemoteEventDesc<MarketplaceService, void(shared_ptr<Instance>, int, bool, MarketplaceService::CurrencyType)> event_promptPurchaseRequested(&MarketplaceService::promptPurchaseRequested, "PromptPurchaseRequested", "player", "assetId", "equipIfPurchased", "currencyType", Security::WiibloxScript, Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::BROADCAST);
	...
	static Reflection::BoundFuncDesc<MarketplaceService, void(std::string, int, int)> func_signalClientPurchaseSuccess(&MarketplaceService::signalClientPurchaseSuccess, "SignalClientPurchaseSuccess", "ticket", "playerId", "productId", Security::WiibloxScript);
	static Reflection::RemoteEventDesc<MarketplaceService, void(std::string, int, int)> event_clientPurchaseSuccess(&MarketplaceService::clientPurchaseSuccess, "ClientPurchaseSuccess", "ticket", "playerId", "productId", Security::WiibloxScript, Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::CLIENT_SERVER);
	static Reflection::RemoteEventDesc<MarketplaceService, void(shared_ptr<const Reflection::ValueTable>)> event_serverPurchaseVerification(&MarketplaceService::serverPurchaseVerification, "ServerPurchaseVerification", "serverResponseTable", Security::WiibloxScript, Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::BROADCAST);

	static Reflection::RemoteEventDesc<MarketplaceService, void(shared_ptr<Instance>, std::string)> event_promptThirdPartyPurchaseRequested(&MarketplaceService::promptThirdPartyPurchaseRequested, "PromptThirdPartyPurchaseRequested", "player", "productId", Security::Wiiblox, Reflection::RemoteEventCommon::REPLICATE_ONLY, Reflection::RemoteEventCommon::BROADCAST);
    
    static Reflection::RemoteEventDesc<MarketplaceService, void(shared_ptr<Instance>, std::string)> event_promptNativePurchaseRequested(&MarketplaceService::promptNativePurchaseRequested, "PromptNativePurchaseRequested", "player", "productId", Security::Wiiblox, Reflection::RemoteEventCommon::REPLICATE_ONLY, Reflection::RemoteEventCommon::BROADCAST);

	// frontend
    
    // used by core script to automatically convert app store product purchases into Wiiblox items
    static Reflection::BoundFuncDesc<MarketplaceService, void(shared_ptr<Instance>, std::string)> func_PromptNativePurchase(&MarketplaceService::promptNativePurchase, "PromptNativePurchase", "player", "productId", Security::WiibloxScript);
	static Reflection::RemoteEventDesc<MarketplaceService, void(shared_ptr<Instance>, std::string, bool)> event_PromptNativePurchaseFinished(&MarketplaceService::nativePurchaseFinished, "NativePurchaseFinished", "player","productId","wasPurchased", Security::WiibloxScript, Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::CLIENT_SERVER);
    
    
    // used by some Wiiblox created games to do direct purchases from app stores
	static Reflection::BoundFuncDesc<MarketplaceService, void(shared_ptr<Instance>, std::string)> func_PromptTPPurchase(&MarketplaceService::promptThirdPartyPurchase, "PromptThirdPartyPurchase", "player", "productId", Security::WiibloxPlace);
	static Reflection::RemoteEventDesc<MarketplaceService, void(shared_ptr<Instance>, std::string, std::string, bool)> event_PromptTPPurchaseFinished(&MarketplaceService::thirdPartyPurchaseFinished, "ThirdPartyPurchaseFinished", "player","productId","receipt","wasPurchased", Security::WiibloxPlace, Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::CLIENT_SERVER);

    
    // WBX dev purchasing calls
    ...
    static Reflection::RemoteEventDesc<MarketplaceService, void(shared_ptr<const Reflection::Tuple>)> event_ClientLuaDialogRequested(&MarketplaceService::clientLuaDialogRequested, "ClientLuaDialogRequested", "arguments", Security::WiibloxScript, Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::CLIENT_SERVER);
	static Reflection::RemoteEventDesc<MarketplaceService, void(bool, shared_ptr<Instance>)> event_luaDialogCallbackSignal(&MarketplaceService::luaDialogCallbackSignal, "LuaDialogCallbackSignal", "value", "player", Security::WiibloxScript, Reflection::RemoteEventCommon::REPLICATE_ONLY, Reflection::RemoteEventCommon::CLIENT_SERVER);
	static Reflection::BoundFuncDesc<MarketplaceService, void(bool)> func_signalServerLuaDialogClosed(&MarketplaceService::signalServerLuaDialogClosed, "SignalServerLuaDialogClosed", "value", Security::WiibloxScript);
	...
	bool MarketplaceService::isValidPlayer(const shared_ptr<Instance> player, const std::string& funcName, boost::function<void(std::string)> errorFunction)
	{
		if(Network::Player* thePlayer = Instance::fastDynamicCast<Network::Player>(player.get()))
		{
			if( thePlayer->getUserID() <=0 ) // warn when we use a guest player (otherwise this call will fail in all local test scenarios!)
			{
				...
				{
					std::string longFuncName = wbx::format("MarketplaceService:%s",funcName.c_str());
					 longFuncName.append(" was called on a guest, please use this call only on players with an account.");
                
					wbx::StandardOut::singleton()->print(wbx::MESSAGE_WARNING, longFuncName);
					return false;
				}
			} 
		} 
	...
	void MarketplaceService::promptProductPurchase(const shared_ptr<Instance> player, const int productId, const bool equipIfPurchased, const CurrencyType currencyType)
	{
		...
		if(Network::Players* players = ServiceProvider::find<wbx::Network::Players>(this))
			if(Network::Players::frontendProcessing(this) &&  (player.get() != players->getLocalPlayer()) )
			{
				wbx::StandardOut::singleton()->printf( wbx::MESSAGE_WARNING, "MarketplaceService:PromptProductPurchase called from a local script, but not called on a local player. Local scripts can only prompt the local player.");
				return;
			}

		if(productId <= 0)
			throw wbx::runtime_error("MarketplaceService:PromptPurchase() second argument is not a valid productId (supplied productId was less than 0)");
		...
		if (dm)
			if (LuaWebService* lws = dm->create<LuaWebService>())
				if (!lws->isApiAccessEnabled())
					throw wbx::runtime_error("Studio API access is not enabled. Enable it by going to the Game Settings page.");
	...
	void MarketplaceService::promptPurchase(const shared_ptr<Instance> player, const int assetId, const bool equipIfPurchased, const CurrencyType currencyType)
	{
		...
		if(Network::Players* players = ServiceProvider::find<wbx::Network::Players>(this))
			if(Network::Players::frontendProcessing(this) &&  (player.get() != players->getLocalPlayer()) )
			{
				wbx::StandardOut::singleton()->printf( wbx::MESSAGE_WARNING, "MarketplaceService:PromptPurchase called from a local script, but not called on a local player. Local scripts can only prompt the local player.");
				return;
			}

		if(assetId <= 0)
			throw wbx::runtime_error("MarketplaceService:PromptPurchase() second argument is not a valid assetId (supplied assetId was less than 0)");
    ...
    void MarketplaceService::processRemoteEvent(const Reflection::EventDescriptor& descriptor, const Reflection::EventArguments& args, const SystemAddress& source)
    {
        if (DFFlag::DoubleCheckPurchase && descriptor == event_promptPurchaseFinished )
        {
            ...
            if (isPurchase)
            {
                ...
                const SystemAddress playerSystemAddress = player->getRemoteAddressAsWbxAddress();
	...
	void MarketplaceService::getProductInfo(const int assetId, const MarketplaceService::InfoType infoType, boost::function<void(shared_ptr<const Reflection::ValueTable>)> resumeFunction, boost::function<void(std::string)> errorFunction)
	{
		...
		if (wbx::HttpWbxApiService* apiService = wbx::ServiceProvider::find<wbx::HttpWbxApiService>(this))
		{
			...
			std::string infoPathFull(wbx::format(infoPath.c_str(),assetId));
			...
			apiService->getAsync(infoPathFull, true, wbx::PRIORITY_DEFAULT,
				boost::bind(&MarketplaceService::onReceivedRawProductInfoSuccess, this, infoPathFull, _1, weak_from(wbx::DataModel::get(this)), resumeFunction, errorFunction),
				boost::bind(&MarketplaceService::onReceivedRawProductInfoError, this, _1, weak_from(wbx::DataModel::get(this)), errorFunction) );
		}
	}

	void MarketplaceService::onReceivedRawProductInfoSuccess(std::string url, std::string response, boost::weak_ptr<wbx::DataModel> weakDM, boost::function<void(shared_ptr<const Reflection::ValueTable>)> resumeFunction, boost::function<void(std::string)> errorFunction)
	{
		if(shared_ptr<wbx::DataModel> sharedDM = weakDM.lock())
		{
			if( response.empty() )
			{
				errorFunction( wbx::format("MarketplaceService:getProductInfo() failed because rawProductInfo was empty") );
				return;
			}
	...
	void MarketplaceService::onReceivedRawProductInfoError(std::string error, boost::weak_ptr<wbx::DataModel> weakDM, boost::function<void(std::string)> errorFunction)
	{
		if(shared_ptr<wbx::DataModel> sharedDM = weakDM.lock())
		{
			if (!error.empty())
			{
				errorFunction( wbx::format("MarketplaceService:getProductInfo() failed because %s", error.c_str()) );
			}
			else
			{
	...
	void MarketplaceService::processPlayerOwnsAssetResponseError(std::string error, boost::function<void(std::string)> errorFunction)
	{
		if (!error.empty())
		{
			errorFunction(wbx::format("MarketPlaceService::PlayerOwnsAsset failed because %s",error.c_str()));
			return;
		}
		else
		{
	...
	void MarketplaceService::playerOwnsAsset(const shared_ptr<Instance> player, const int assetId, boost::function<void(bool)> resumeFunction, boost::function<void(std::string)> errorFunction)
	{
		...
		if (wbx::HttpWbxApiService* apiService = wbx::ServiceProvider::find<wbx::HttpWbxApiService>(this))
		{
			apiService->getAsync( wbx::format(playerOwnsAssetUrl.c_str(), userId, assetId), true, wbx::PRIORITY_DEFAULT,
	...
	void MarketplaceService::verifyPurchaseErrorNoDMLock(std::string error, int userId, int productId)
	{
		...
		shared_ptr<Reflection::ValueTable> values(wbx::make_shared<Reflection::ValueTable>());
	...
	void MarketplaceService::verifyPurchaseTicket(std::string ticket, int userId, int productId)
	{
		if (Network::Players::backendProcessing(this, false))
		{
			if (wbx::HttpWbxApiService* apiService = wbx::ServiceProvider::find<wbx::HttpWbxApiService>(this))
			{
				apiService->postAsync( wbx::format("%s/validatepurchase?receipt=%s", urlApiPath(), ticket.c_str()), std::string("GameServerVerifyPurchase"), true, wbx::PRIORITY_EXTREME, HttpService::TEXT_PLAIN,
	...
	bool MarketplaceService::launchClientLuaDialog(std::string message, std::string accept, std::string decline, shared_ptr<Instance> player, boost::function<void(bool, shared_ptr<Instance>)> callback)
	{
		if (Network::Player* thePlayer = Instance::fastDynamicCast<Network::Player>(player.get()))
		{
			...
			const wbx::SystemAddress& target = thePlayer->getRemoteAddressAsWbxAddress();
	...
	void MarketplaceService::onServiceProvider(ServiceProvider* oldSp, ServiceProvider* newSp)
	{
		...
		if (newSp)
		{
			verifyPurchaseConnection = clientPurchaseSuccess.connect(boost::bind(&wbx::MarketplaceService::verifyPurchaseTicket,
				this, _1, _2, _3));
		}
	}
	...
	void MarketplaceService::processReceiptsCallbackChanged(const ReceiptCallback& oldValue)
	{
		if (!Network::Players::backendProcessing(this))
		{
			...
			throw wbx::runtime_error("Can only register ProcessReceipt callback on server");
		}
	...
	{
		WBXASSERT(Network::Players::backendProcessing(this));
		WBXASSERT(!receiptProcessingEnabledByUser);
		receiptProcessingEnabledByUser = false;
	...
	void MarketplaceService::fetchAndProcessTransactions(int userId)
	{
			...
			ServiceProvider::create<LuaWebService>(this)->isApiAccessEnabled())
		{
			...
			if (placeId > 0 && userId > 0)
			{
				...
				if (wbx::HttpWbxApiService* apiService = wbx::ServiceProvider::find<wbx::HttpWbxApiService>(this))
				{
					apiService->getAsync(http, wbx::PRIORITY_EXTREME,
		...
		if (shared_ptr<MarketplaceService> mk = weakMk.lock())
		{
			if (!mk->receiptCallback.empty())
			{
				try
				{
					...
					catch (const wbx::base_exception&)
					{
						WBXASSERT(false);
					}
		...
		std::string receiptId, int currencyType, int currencySpent, shared_ptr<const Reflection::Tuple> result)
	{
		...
		{
			if (wbx::HttpWbxApiService* apiService = wbx::ServiceProvider::find<wbx::HttpWbxApiService>(mk.get()))
			{
				apiService->postAsync("gametransactions/settransactionstatuscomplete", format("receipt=%s", receiptId.c_str()), true, wbx::PRIORITY_EXTREME, HttpService::APPLICATION_URLENCODED,
			...
			WiibloxGoogleAnalytics::trackEvent(GA_CATEGORY_GAME, 
	...
	void MarketplaceService::promptThirdPartyPurchase(const shared_ptr<Instance> player, std::string thirdPartyProductId)
	{
		...
		if(Network::Players* players = ServiceProvider::find<wbx::Network::Players>(this))
        {
			if(Network::Players::frontendProcessing(this) &&  (player.get() != players->getLocalPlayer()) )
			{
				wbx::StandardOut::singleton()->printf( wbx::MESSAGE_WARNING, "MarketplaceService:PromptThirdPartyPurchase called from a local script, but not called on a local player. Local scripts can only prompt the local player.");
				return;
			}
        }
        
        if(thirdPartyProductId.empty())
            throw wbx::runtime_error("MarketplaceService:PromptThirdPartyPurchase() productId is empty");
    ...
    void MarketplaceService::promptNativePurchase(const shared_ptr<Instance> player, std::string nativeProductId)
    {
		...
		if(Network::Players* players = ServiceProvider::find<wbx::Network::Players>(this))
        {
			if(Network::Players::frontendProcessing(this) &&  (player.get() != players->getLocalPlayer()) )
			{
				wbx::StandardOut::singleton()->printf( wbx::MESSAGE_WARNING, "MarketplaceService:PromptNativePurchase called from a local script, but not called on a local player. Local scripts can only prompt the local player.");
				return;
			}
        }
        
        if(nativeProductId.empty())
            throw wbx::runtime_error("MarketplaceService:PromptNativePurchase() productId is empty");
