...
namespace WBX
{
    ...
    , texture("WBXasset://textures/particles/sparkles_main.dds")
    , color( Color3(1,1,1) )
    , transparency(0)
    , size( 1 )
    , lightEmission(0)
    ...
    {
        wbx::WiibloxGoogleAnalytics::trackEvent(GA_CATEGORY_GAME, "CustomParticleEmitter");
    }
