...
HitTestFilter::Result FilterInvisibleNonColliding::filterResult(const wbx::Primitive *testMe) const
{
...
HitTestFilter::Result FilterDescendents::filterResult(const wbx::Primitive *testMe) const
{
	if (inst) 
	{
		const PartInstance* testPart = PartInstance::fromConstPrimitive(testMe);
...
HitTestFilter::Result FilterDescendentsList::filterResult(const wbx::Primitive *testMe) const
{
	if (instances) 
	{
		const PartInstance* testPart = PartInstance::fromConstPrimitive(testMe);
...
HitTestFilter::Result FilterCharacterOcclusion::filterResult(const wbx::Primitive *testMe) const
{
	const PartInstance* testPart = PartInstance::fromConstPrimitive(testMe);
...
HitTestFilter::Result FilterHumanoidParts::filterResult(const wbx::Primitive* testMe) const
{
	const PartInstance* testPart = PartInstance::fromConstPrimitive(testMe);
...
HitTestFilter::Result FilterHumanoidNameOcclusion::filterResult(const wbx::Primitive* testMe) const
{
	const PartInstance* testPart = PartInstance::fromConstPrimitive(testMe);
