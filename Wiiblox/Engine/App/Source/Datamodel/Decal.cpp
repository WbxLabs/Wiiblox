...
const char* const wbx::sDecal = "Decal";
...
template<>
const Type& Type::getSingleton<wbx::TextureId>()
{
	return Type::singleton<ContentId>();
}

template<>
void TypedPropertyDescriptor<wbx::TextureId>::readValue(DescribedBase* instance, const XmlElement* element, IReferenceBinder& binder) const
{
	if (!element->isXsiNil())
	{
		ContentId value;
...
template<>
void TypedPropertyDescriptor<wbx::TextureId>::writeValue(const DescribedBase* instance, XmlElement* element) const
{
...
template<>
int TypedPropertyDescriptor<wbx::TextureId>::getDataSize(const DescribedBase* instance) const 
{
    return sizeof(wbx::TextureId) + getValue(instance).toString().size();
}

template<>
bool TypedPropertyDescriptor<wbx::TextureId>::hasStringValue() const {
	return true;
}

template<>
std::string TypedPropertyDescriptor<wbx::TextureId>::getStringValue(const DescribedBase* instance) const{
	return StringConverter<wbx::TextureId>::convertToString(getValue(instance));
}

template<>
bool TypedPropertyDescriptor<wbx::TextureId>::setStringValue(DescribedBase* instance, const std::string& text) const {
	wbx::TextureId value;
	if (StringConverter<wbx::TextureId>::convertToValue(text, value))
	{
		setValue(instance, value);
		return true;
	}
...
const char* const wbx::sDecalTexture = "Texture";
