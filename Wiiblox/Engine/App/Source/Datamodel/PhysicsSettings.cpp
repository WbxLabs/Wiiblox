...
const char *const wbx::sPhysicsSettings = "PhysicsSettings";

// Don't show tree in release mode - has Wiiblox specific secrets as to how we do assembly

#ifdef _DEBUG
	#define __WBX_SECRET_DEBUGGING
#endif
...
#if defined(WBX_TEST_BUILD) || WBX_PLATFORM_IOS
