...
using namespace WBX;
const char *const wbx::sGameSettings = "GameSettings";
...
static Reflection::EventDesc<GameSettings, void(bool)> event_videoRecordingRequest(&GameSettings::videoRecordingSignal, "VideoRecordingChangeRequest","recording",Security::WiibloxScript);
