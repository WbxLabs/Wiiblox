...
namespace WBX
{
	...
	template<>
	const wbx::WBXRay RayValue::defaultValue(G3D::Vector3(0,0,0),G3D::Vector3(0,0,0));
	template<>
	Reflection::BoundProp<wbx::WBXRay> RayValue::desc_Value("Value", category_Data, &RayValue::value, &RayValue::onValueChanged);
	template<>
	Reflection::EventDesc< RayValue, void(wbx::WBXRay)> RayValue::desc_ValueChanged(&RayValue::valueChangedSignal, "Changed", "value");
	Reflection::EventDesc< RayValue, void(wbx::WBXRay)> dep_RayValueChanged(&RayValue::valueChangedSignal, "changed", "value", Reflection::Descriptor::Attributes::deprecated(RayValue::desc_ValueChanged));
