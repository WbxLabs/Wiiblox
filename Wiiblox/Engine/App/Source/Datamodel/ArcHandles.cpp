...
Reflection::RemoteEventDesc<ArcHandles, void(wbx::Vector3::Axis)>	   event_MouseEnter(&ArcHandles::mouseEnterSignal,		  "MouseEnter",       "axis", Security::None, Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::CLIENT_SERVER);
Reflection::RemoteEventDesc<ArcHandles, void(wbx::Vector3::Axis)>	   event_MouseLeave(&ArcHandles::mouseLeaveSignal,		  "MouseLeave",		  "axis", Security::None, Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::CLIENT_SERVER);
Reflection::RemoteEventDesc<ArcHandles, void(wbx::Vector3::Axis, float, float)> event_MouseDrag(&ArcHandles::mouseDragSignal, "MouseDrag",		  "axis", "relativeAngle", "deltaRadius", Security::None, Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::CLIENT_SERVER);
Reflection::RemoteEventDesc<ArcHandles, void(wbx::Vector3::Axis)> event_MouseButton1Down(&ArcHandles::mouseButton1DownSignal, "MouseButton1Down", "axis", Security::None, Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::CLIENT_SERVER);
Reflection::RemoteEventDesc<ArcHandles, void(wbx::Vector3::Axis)> event_MouseButton1Up  (&ArcHandles::mouseButton1UpSignal,   "MouseButton1Up",	  "axis", Security::None, Reflection::RemoteEventCommon::SCRIPTING, Reflection::RemoteEventCommon::CLIENT_SERVER);
...
{
	Faces faces;
	faces.setNormalId(wbx::NORM_X, axes.getAxisByNormalId(wbx::NORM_X));
	faces.setNormalId(wbx::NORM_Y, axes.getAxisByNormalId(wbx::NORM_Y));
	faces.setNormalId(wbx::NORM_Z, axes.getAxisByNormalId(wbx::NORM_Z));

	faces.setNormalId(wbx::NORM_X_NEG, axes.getAxisByNormalId(wbx::NORM_X));
	faces.setNormalId(wbx::NORM_Y_NEG, axes.getAxisByNormalId(wbx::NORM_Y));
	faces.setNormalId(wbx::NORM_Z_NEG, axes.getAxisByNormalId(wbx::NORM_Z));
...
wbx::HandleType ArcHandles::getHandleType() const 
{
