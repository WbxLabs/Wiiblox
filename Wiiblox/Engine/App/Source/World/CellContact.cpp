...
bool CellMeshContact::cellFaceIsInterior(const Vector3int16& mainCellLoc, wbx::Voxel::FaceDirection faceDir)
{
    using namespace Voxel;
    
	Grid* vs = WBX_static_cast<MegaClusterInstance*>(getPrimitive(0)->getOwner())->getVoxelGrid();
