...
void AssemblyStage::onSimulateAssemblyDescendentAdded(Assembly* a)
{
	...
	WBX_static_cast<MovingAssemblyStage*>(getDownstreamWS())->onSimulateAssemblyAdded(a);
...
void AssemblyStage::onSimulateAssemblyDescendentRemoving(Assembly* a) 
{
	...
	WBX_static_cast<MovingAssemblyStage*>(getDownstreamWS())->onSimulateAssemblyRemoving(a);
