...
bool wbx::vmProtectedDetectCheatEngineIcon()
{
...
namespace WBX
{
    ...
    TaskScheduler::StepResult VerifyConnectionJob::step(const Stats& stats)
    {
        ...
        WiibloxGoogleAnalytics::trackUserTiming(GA_CATEGORY_GAME, GA_CLIENT_START, cePerfTime.msec(), "Process hotfixes");

        return wbx::TaskScheduler::Done;
    }
    ...
    void DbvmCanary::checkAndLocalUpdate()
    {
        ...
        if (isBadHash)
        {
            ...
            wbx::Security::setHackFlagVmp<LINE_RAND4>(wbx::Security::hackFlag7, HATE_CHEATENGINE_OLD);
        }
        VMProtectEnd();
    }
