...
namespace WBX {
	...
	private:
		...
		BrickMap()
		{
			...
			insert(BrickColor::Wiiblox_1001, 248, 248, 248, "Institutional white");
			insert(BrickColor::Wiiblox_1002, 205, 205, 205, "Mid gray");
			insert(BrickColor::Wiiblox_1003, 17, 17, 17, "Really black");
			insert(BrickColor::Wiiblox_1004, 255, 0, 0, "Really red");
			insert(BrickColor::Wiiblox_1005, 255, 175, 0, "Deep orange");
			insert(BrickColor::Wiiblox_1006, 180, 128, 255, "Alder");
			insert(BrickColor::Wiiblox_1007, 163, 75, 75, "Dusty Rose");
			insert(BrickColor::Wiiblox_1008, 193, 190, 66, "Olive");
			insert(BrickColor::Wiiblox_1009, 255, 255, 0, "New Yeller");
			insert(BrickColor::Wiiblox_1010, 0, 0, 255, "Really blue");
			insert(BrickColor::Wiiblox_1011, 0, 32, 96, "Navy blue");
			insert(BrickColor::Wiiblox_1012, 33, 84, 185, "Deep blue");
			insert(BrickColor::Wiiblox_1013, 4, 175, 236, "Cyan");
			insert(BrickColor::Wiiblox_1014, 170, 85, 0, "CGA brown");
			insert(BrickColor::Wiiblox_1015, 170, 0, 170, "Magenta");
			insert(BrickColor::Wiiblox_1016, 255, 102, 204, "Pink");
			insert(BrickColor::Wiiblox_1017, 255, 175, 0, "Deep orange");
			insert(BrickColor::Wiiblox_1018, 18, 238, 212, "Teal");
			insert(BrickColor::Wiiblox_1019, 0, 255, 255, "Toothpaste");
			insert(BrickColor::Wiiblox_1020, 0, 255, 0, "Lime green");
			insert(BrickColor::Wiiblox_1021, 58, 125, 21, "Camo");
			insert(BrickColor::Wiiblox_1022, 127, 142, 100, "Grime");
			insert(BrickColor::Wiiblox_1023, 140, 91, 159, "Lavender");
			insert(BrickColor::Wiiblox_1024, 175, 221, 255, "Pastel light blue");
			insert(BrickColor::Wiiblox_1025, 255, 201, 201, "Pastel orange");
			insert(BrickColor::Wiiblox_1026, 177, 167, 255, "Pastel violet");
			insert(BrickColor::Wiiblox_1027, 159, 243, 233, "Pastel blue-green");
			insert(BrickColor::Wiiblox_1028, 204, 255, 204, "Pastel green");
			insert(BrickColor::Wiiblox_1029, 255, 255, 204, "Pastel yellow");
			insert(BrickColor::Wiiblox_1030, 255, 204, 153, "Pastel brown");
			insert(BrickColor::Wiiblox_1031, 98, 37, 209, "Royal purple");
			insert(BrickColor::Wiiblox_1032, 255, 0, 191, "Hot pink");
	...
	public:
		void setRenderingSupportedPaletteSize(size_t maxSupportedColors)
		{
			...
			renderingPalette.push_back(BrickColor::Wiiblox_1012);
			renderingPalette.push_back(BrickColor::brick_303);
			renderingPalette.push_back(BrickColor::Wiiblox_1011);
			renderingPalette.push_back(BrickColor::brick_304);
			renderingPalette.push_back(BrickColor::brick_28);
			renderingPalette.push_back(BrickColor::Wiiblox_1018);
			...
			renderingPalette.push_back(BrickColor::Wiiblox_1021);
			renderingPalette.push_back(BrickColor::brick_309);
			renderingPalette.push_back(BrickColor::brick_310);
			renderingPalette.push_back(BrickColor::Wiiblox_1019);
			...
			renderingPalette.push_back(BrickColor::Wiiblox_1010);
			...
			renderingPalette.push_back(BrickColor::Wiiblox_1022);
			renderingPalette.push_back(BrickColor::Wiiblox_1020);
			renderingPalette.push_back(BrickColor::Wiiblox_1027);
			renderingPalette.push_back(BrickColor::brick_314);
			renderingPalette.push_back(BrickColor::brick_315);
			renderingPalette.push_back(BrickColor::Wiiblox_1023);
			renderingPalette.push_back(BrickColor::Wiiblox_1031);
			...
			renderingPalette.push_back(BrickColor::Wiiblox_1024);
			renderingPalette.push_back(BrickColor::Wiiblox_1013);
			renderingPalette.push_back(BrickColor::Wiiblox_1006);
			...
			renderingPalette.push_back(BrickColor::Wiiblox_1008);
			...
			renderingPalette.push_back(BrickColor::Wiiblox_1026);
			renderingPalette.push_back(BrickColor::Wiiblox_1016);
			renderingPalette.push_back(BrickColor::Wiiblox_1032);
			renderingPalette.push_back(BrickColor::Wiiblox_1015);
			renderingPalette.push_back(BrickColor::brick_327);
			renderingPalette.push_back(BrickColor::Wiiblox_1017);
			renderingPalette.push_back(BrickColor::Wiiblox_1009);
			renderingPalette.push_back(BrickColor::brick_29);
			renderingPalette.push_back(BrickColor::brick_328);
			renderingPalette.push_back(BrickColor::Wiiblox_1028);
			...
			renderingPalette.push_back(BrickColor::Wiiblox_1004);
			...
			renderingPalette.push_back(BrickColor::Wiiblox_1001);
			...
			renderingPalette.push_back(BrickColor::Wiiblox_1014);
			...
			renderingPalette.push_back(BrickColor::Wiiblox_1030);
			...
			renderingPalette.push_back(BrickColor::Wiiblox_1002);
			...
			renderingPalette.push_back(BrickColor::Wiiblox_1003);
		...
		void updateColorPalette()
		{
			...
			insertPaletteItem(BrickColor::Wiiblox_1012);
			insertPaletteItem(BrickColor::brick_303);
			insertPaletteItem(BrickColor::Wiiblox_1011);
			insertPaletteItem(BrickColor::brick_304);
			insertPaletteItem(BrickColor::brick_28);
			insertPaletteItem(BrickColor::Wiiblox_1018);
			...
			insertPaletteItem(BrickColor::Wiiblox_1024);				
			insertPaletteItem(BrickColor::brick_314);				
			insertPaletteItem(BrickColor::Wiiblox_1013);
			insertPaletteItem(BrickColor::Wiiblox_1006);
			insertPaletteItem(BrickColor::brick_321);
			insertPaletteItem(BrickColor::brick_322);
			insertPaletteItem(BrickColor::brick_104);
			insertPaletteItem(BrickColor::Wiiblox_1008);
			...
			insertPaletteItem(BrickColor::Wiiblox_1026);
			insertPaletteItem(BrickColor::Wiiblox_1016);
			insertPaletteItem(BrickColor::Wiiblox_1032);
			insertPaletteItem(BrickColor::Wiiblox_1015);
			insertPaletteItem(BrickColor::brick_327);
			insertPaletteItem(BrickColor::Wiiblox_1017);
			insertPaletteItem(BrickColor::Wiiblox_1009);
			insertPaletteItem(BrickColor::brick_29);
			insertPaletteItem(BrickColor::brick_328);
			insertPaletteItem(BrickColor::Wiiblox_1028);
			...
			insertPaletteItem(BrickColor::Wiiblox_1004);
			...
			insertPaletteItem(BrickColor::Wiiblox_1029);
			...
			insertPaletteItem(BrickColor::Wiiblox_1007);
			insertPaletteItem(BrickColor::brick_339);
			//insertPaletteItem(BrickColor::Wiiblox_1005);
			...
			insertPaletteItem(BrickColor::Wiiblox_1030);
			...
			insertPaletteItem(BrickColor::Wiiblox_1002);
			...
			insertPaletteItem(BrickColor::Wiiblox_1003);
	...
	G3D::Color4uint8 BrickColor::color4uint8() const {
		const std::vector<BrickMap::ColorInfo>& colors = BrickMap::singleton().map;
		WBXASSERT(static_cast<unsigned int>(number) < colors.size() && colors[number].valid);
