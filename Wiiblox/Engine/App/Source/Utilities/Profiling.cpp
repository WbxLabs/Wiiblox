...
void wbx::Profiling::init(bool enabled)
{
...
void wbx::Profiling::setEnabled(bool enabled)
{
	profilingEnabled = enabled;
#ifdef _WIN32
	...
	// of a Mark.
	WBXASSERT(markTlsIndex);
#endif
}

bool wbx::Profiling::isEnabled()
{
...
void CodeProfiler::log(bool frameTick, double wallTimeElapsed)
{
	...
	//WBXASSERT(wallTimeElapsed>=-0.001);
