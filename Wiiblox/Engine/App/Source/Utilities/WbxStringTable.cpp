...
static const char *stringsTable[] = 
	{
		...
		"Script", //ScriptStr
		"rocky", //Rocky
		"Game passes can only be queried by a Script running on a Wiiblox game server", //HasGamePassLuaWarning
		"Teleporting while using Wiiblox Studio is not permitted.", //NoTeleportInStudio
