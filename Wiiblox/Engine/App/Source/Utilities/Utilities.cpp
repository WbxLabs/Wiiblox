...
const std::string wbx::Http::kGameSessionHeaderKey = "Wiiblox-Session-Id";
const std::string wbx::Http::kGameIdHeaderKey = "Wiiblox-Game-Id";
const std::string wbx::Http::kPlaceIdHeaderKey = "Wiiblox-Place-Id";
const std::string wbx::Http::kRequesterHeaderKey = "Requester";
const std::string wbx::Http::kPlayerCountHeaderKey = "PlayerCount";
const std::string wbx::Http::kAccessHeaderKey = "accesskey";
const std::string wbx::Http::kAssetTypeKey = "AssetType";
const std::string wbx::Http::kWBXAuthenticationNegotiation = "WBXAuthenticationNegotiation";
const std::string wbx::Http::kContentTypeDefaultUnspecified = "*/*";
const std::string wbx::Http::kContentTypeUrlEncoded = "application/x-www-form-urlencoded";
const std::string wbx::Http::kContentTypeApplicationJson = "application/json";
const std::string wbx::Http::kContentTypeApplicationXml = "application/xml";
const std::string wbx::Http::kContentTypeTextPlain = "text/plain";
const std::string wbx::Http::kContentTypeTextXml = "text/xml";
std::string wbx::Http::lastCsrfToken = "";
boost::mutex wbx::Http::lastCsrfTokenMutex;
...
std::string wbx::sha1(const std::string& source)
{
	if (source.empty())
		return source;
...
#ifdef _DEBUG
		double temp;
		WBXASSERT(StringConverter<double>::convertToValue(szText, temp));
		WBXASSERT(temp==value);
#endif
		return szText;
	}
	////////////////////////////////////////////////////////////////////////////////
...
#ifdef _DEBUG
		float temp;
		WBXASSERT(StringConverter<float>::convertToValue(szText, temp));
		WBXASSERT(temp==value);
#endif
		return szText;
	}
