...
// early to prevent errors on mac builds, but on windows builds WBXPlatform
// needs to come before property_tree, to prevent a winsock conflict.
#include "WBXPlatform.h"
...
const char* MachineIdUploader::kBannedMachineMessage = "Wiiblox cannot startup. User code = 0x1.";
