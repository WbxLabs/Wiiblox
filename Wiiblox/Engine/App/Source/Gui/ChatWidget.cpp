...
{
	wbx::Network::Players* players = ServiceProvider::find<wbx::Network::Players>(this);

	return (players && players->getLocalPlayer() && wbx::Network::Players::clientIsPresent(this));
}
