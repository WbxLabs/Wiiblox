...
const Reflection::BoundFuncDesc<Script, std::string()> Script::func_GetHash(&Script::getHash, "GetHash", Security::WiibloxPlace);
...
{
	WBXASSERT(getCachedRemoteSourceLoadState() != NotAttemptedToLoad);
