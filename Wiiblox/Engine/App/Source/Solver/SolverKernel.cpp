...
static WBX_SIMD_INLINE EffectiveMassPair computeEffectiveMassPair( 
...
void PGSComputeEffectiveMasses( 
    ...
    const SolverConfig& _config )
{
    WBXPROFILER_SCOPE("Physics", "PGSComputeEffectiveMasses");
...
// Helper methods
template< int DIM >
static WBX_SIMD_INLINE void applyPreconditionerToStage( 
...
// Helper methods
static WBX_SIMD_INLINE void applyPreconditionerToJacobian( ConstraintJacobianPair* __restrict _r, const v4f& _preconditioner, const ConstraintJacobianPair* __restrict _j, const v4f& _sor )
{
...
template< >
WBX_SIMD_INLINE void applyPreconditionerToStage< 1 >(
    ConstraintVariables* __restrict _vars,
    ConstraintJacobianPair* __restrict _preJacobians,
    const boost::uint8_t* _useBlock,
    const ConstraintJacobianPair* __restrict _jacobian,
...
static WBX_SIMD_INLINE void multiplyRowByColumn( ConstraintJacobianPair* __restrict _r, const SymmetricMatrix2SIMD& _preconditioner, const ConstraintJacobianPair* __restrict _j, const v4f& _sor )
{
...
static WBX_SIMD_INLINE void applyPreconditionerToSubMatrix( ConstraintJacobianPair* __restrict _r, const SymmetricMatrix2SIMD& _preconditioner, const ConstraintJacobianPair* __restrict _j, const v4f& _sor )
{
...
static WBX_SIMD_INLINE void applyPreconditionerToJacobian( ConstraintJacobianPair* __restrict _r, const SymmetricMatrix2SIMD& _preconditioner, const ConstraintJacobianPair* __restrict _j, const v4f& _sor )
{
...
static WBX_SIMD_INLINE SymmetricMatrix2SIMD constraintMatrixDiagBlockInverse2( const boost::uint8_t* _useBlock, const ConstraintJacobianPair* _jacobian, const EffectiveMassPair* _massVectors )
{
...
template< >
WBX_SIMD_INLINE void applyPreconditionerToStage< 2 >(
    ConstraintVariables* __restrict _vars,
    ConstraintJacobianPair* __restrict _preJacobians,
    const boost::uint8_t* _useBlock,
    const ConstraintJacobianPair* __restrict _jacobian,
...
// Helper methods
template< int row, class SubMatrixSelect >
static WBX_SIMD_INLINE void multiplyRowByColumn( ConstraintJacobianPair* __restrict _r, const SymmetricMatrixSIMD& _preconditioner, const ConstraintJacobianPair* __restrict _j, const v4f& _sor )
{
    v4f r = _preconditioner.get<row,0>() * _j[0].get< SubMatrixSelect >() 
          + _preconditioner.get<row,1>() * _j[1].get< SubMatrixSelect >() 
...
template< class SubMatrixSelect >
static WBX_SIMD_INLINE void applyPreconditionerToSubMatrix( ConstraintJacobianPair* __restrict _r, const SymmetricMatrixSIMD& _preconditioner, const ConstraintJacobianPair* __restrict _j, const v4f& _sor )
{
    multiplyRowByColumn< 0, SubMatrixSelect >(_r, _preconditioner, _j, _sor);
    multiplyRowByColumn< 1, SubMatrixSelect >(_r, _preconditioner, _j, _sor);
...
static WBX_SIMD_INLINE void applyPreconditionerToJacobian( ConstraintJacobianPair* __restrict _r, const SymmetricMatrixSIMD& _preconditioner, const ConstraintJacobianPair* __restrict _j, const v4f& _sor )
{
    applyPreconditionerToSubMatrix< Jac::LinA >( _r, _preconditioner, _j, _sor );
    applyPreconditionerToSubMatrix< Jac::AngA >( _r, _preconditioner, _j, _sor );
    applyPreconditionerToSubMatrix< Jac::LinB >( _r, _preconditioner, _j, _sor );
...
static WBX_SIMD_INLINE SymmetricMatrixSIMD constraintMatrixDiagBlockInverse3( const boost::uint8_t* _useBlock, const ConstraintJacobianPair* _jacobian, const EffectiveMassPair* _massVectors )
{
    v4f d01 = _jacobian[0].dot( _massVectors[1] );
...
// Dim 3 pre-conditioner
template< >
WBX_SIMD_INLINE void applyPreconditionerToStage< 3 >(
    ConstraintVariables* __restrict _vars,
    ConstraintJacobianPair* __restrict _preJacobians,
    const boost::uint8_t* _useBlock,
    const ConstraintJacobianPair* __restrict _jacobian,
...
void PGSPreconditionConstraintEquations( 
    ...
    const EffectiveMassPair* __restrict _effectiveMassesPosStage )
{
    WBXPROFILER_SCOPE("Physics", "PGSPreconditionConstraintEquations");
    ...
    for( size_t c = 0; c < _constraintCount; c++ )
    {
        ...
        WBXASSERT_VERY_FAST( d <= maxConstraintDimension );
...
void PGSApplyEffectiveMassMultipliers( 
    ...
    const SolverConfig& _config )
{
    WBXPROFILER_SCOPE("Physics", "PGSApplyEffectiveMassMultipliers");
...
static WBX_SIMD_INLINE VirtualDisplacement applyImpulse( const VirtualDisplacement& virD, const simd::v4f& impulse, const EffectiveMass& eff )
{
...
void PGSInitVirtualDisplacements( 
    ...
    const SolverConfig& _config )
{
    WBXPROFILER_SCOPE("Physics", "PGSInitVirtualDisplacements");
...
static WBX_SIMD_INLINE v4f partiallyProjectOntoJacobian( const ConstraintJacobianPair& _j, const VirtualDisplacement& _va, const VirtualDisplacement& _vb )
{
...
template<class Type >
static WBX_SIMD_INLINE void modifyImpulseBounds( v4f& minBound, v4f& maxBound, const v4f& oldImpulses )
{ }

// For collisions we need to do something different to simulate the friction cone
template<>
WBX_SIMD_INLINE void modifyImpulseBounds< CollisionType >( v4f& minBound, v4f& maxBound, const v4f& oldImpulses )
{
...
template< class Type >
static WBX_SIMD_INLINE void updateConstraintDim3OrCollisionSingleStage( 
    ConstraintVariables* __restrict _vars,
...
void PGSSolveKernel(
    ...
    const SolverConfig& _config )
{
    WBXPROFILER_SCOPE("Physics", "PGSSolveKernel");
...
void PGSSolveKernelComputeErrors(
    ...
    const SolverConfig& _config )
{
    WBXPROFILER_SCOPE("Physics", "PGSSolveKernelComputeErrors");
