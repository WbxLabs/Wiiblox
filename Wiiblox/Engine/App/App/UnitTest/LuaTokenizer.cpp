...
{
	std::vector<std::string> args = wbx::Lua::ArgumentParser::getArgsInBracket("( a() )");
...
{
	std::vector<std::string> args = wbx::Lua::ArgumentParser::getArgsInBracket("( a , 34+s(r, 6), 'd\\'fg'\t, \"sd'fs\")");
...
{
	std::vector<std::string> args = wbx::Lua::ArgumentParser::getArgsInBracket("( function() return 1 end )");
	BOOST_REQUIRE_EQUAL(args.size(), 1);
...
BOOST_AUTO_TEST_CASE(Limitation)
{
	...
	std::vector<std::string> args = wbx::Lua::ArgumentParser::getArgsInBracket("( function() return 1, 2 end )");
