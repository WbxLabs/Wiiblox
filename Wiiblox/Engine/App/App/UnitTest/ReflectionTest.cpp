...
WBX_REGISTER_CLASS(ReflectionTestSubclass);
WBX_REGISTER_CLASS(ReflectionTestClass);
	...
	{
		{
			...
			wbx::Reflection::Property prop(*test.findPropertyDescriptor("P"), &test);
			BOOST_CHECK_EQUAL(&prop.getDescriptor(), &prop0);
		}
		{
			ReflectionTestSubclass sub;
			wbx::Reflection::Property prop(*sub.findPropertyDescriptor("P"), &sub);
