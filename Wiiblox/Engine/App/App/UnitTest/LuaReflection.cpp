...
{
	template<>
	bool wbx::StringConverter<TestEnum>::convertToValue(const std::string& text, TestEnum& value)
	{
		return wbx::Reflection::EnumDesc<TestEnum>::singleton().convertToValue(text.c_str(),value);
	}
...
public:
	...
	shared_ptr<const wbx::Reflection::Tuple> tuple(int x, int y, int z)
	{
	...
	shared_ptr<const wbx::Reflection::Tuple> tupleTest(shared_ptr<const wbx::Reflection::Tuple> inout)
	{
		...
		return wbx::make_shared<const wbx::Reflection::Tuple>(inout);
#else
		shared_ptr<wbx::Reflection::Tuple> result = wbx::make_shared<wbx::Reflection::Tuple>(inout->values.size());
	...
	shared_ptr<const wbx::Reflection::Tuple> enumtuple(int x, int y, int z)
	{
		shared_ptr<wbx::Reflection::Tuple> result(new wbx::Reflection::Tuple(3));
		result->values[0] = wbx::PartInstance::SYMETRIC;
		result->values[1] = wbx::PartInstance::SYMETRIC;
		result->values[2] = wbx::PartInstance::PLATE;
		return result;
	}
	void voidCall()
	{
...
static Reflection::BoundFuncDesc<LuaReflectionTest, shared_ptr<const wbx::Reflection::Tuple>(shared_ptr<const wbx::Reflection::Tuple>)> func_TupleTest(&LuaReflectionTest::tupleTest, "TupleTest", "inout", Security::None);
static Reflection::BoundFuncDesc<LuaReflectionTest, shared_ptr<const wbx::Reflection::Tuple>(int, int, int)> callTuple(&LuaReflectionTest::tuple, "Tuple", "x", "y", "z", Security::None);
static Reflection::BoundFuncDesc<LuaReflectionTest, shared_ptr<const wbx::Reflection::Tuple>(int, int, int)> callEnumTuple(&LuaReflectionTest::enumtuple, "EnumTuple", "x", "y", "z", Security::None);
...
WBX_REGISTER_CLASS(LuaReflectionTest);
...
BOOST_FIXTURE_TEST_CASE(Inst, DataModelFixture)
{
	...
	std::auto_ptr<wbx::Reflection::Tuple> result = execute
		(
...
static shared_ptr<wbx::Reflection::Tuple> check_pcall_aux(wbx::Reflection::Tuple* args, double a, double b, shared_ptr<wbx::CEvent> event)
{
...
static shared_ptr<wbx::Reflection::Tuple> check_pcall(shared_ptr<const wbx::Reflection::Tuple> args, double a, double b, shared_ptr<wbx::CEvent> event)
{
	BOOST_REQUIRE_GE(args->values.size(), (size_t) 1);
	BOOST_CHECK_EQUAL(args->at(0).get<bool>(), b != 0.0);
	BOOST_REQUIRE_EQUAL(args->values.size(), (size_t) 2);
...
static shared_ptr<wbx::Reflection::Tuple> check_old_style_failure(shared_ptr<const wbx::Reflection::Tuple> args, shared_ptr<wbx::CEvent> event)
{
...
BOOST_FIXTURE_TEST_CASE(ypcallAsyncSuccess, DataModelFixture)
{
	...
	for (int i = 0; i < 100; ++i)
	{
		shared_ptr<wbx::CEvent> event(wbx::make_shared<CEvent>(true));
		wbx::Reflection::Tuple args(1);
		args.values[0] = shared_ptr<wbx::Lua::GenericFunction>(new wbx::Lua::GenericFunction(boost::bind(&check_pcall, _1, 1, 2, event)));
		execute
			(
			"callback = ... \n"
...
BOOST_FIXTURE_TEST_CASE(ypcallAsyncFailure, DataModelFixture)
{
	...
	for (int i = 0; i < 100; ++i)
	{
		shared_ptr<wbx::CEvent> event(wbx::make_shared<CEvent>(true));
		wbx::Reflection::Tuple args(1);
		args.values[0] = shared_ptr<wbx::Lua::GenericFunction>(new wbx::Lua::GenericFunction(boost::bind(&check_pcall, _1, 2, 0, event)));
		execute
			(
			"callback = ... \n"
...
BOOST_FIXTURE_TEST_CASE(AsyncFailure, DataModelFixture)
{
	shared_ptr<wbx::CEvent> event(wbx::make_shared<CEvent>(true));
	wbx::Reflection::Tuple args(1);
	args.values[0] = shared_ptr<wbx::Lua::GenericFunction>(new wbx::Lua::GenericFunction(boost::bind(&check_old_style_failure, _1, event)));
	execute
		(
		"callback = ... \n"
		"l = Instance.new('LuaReflectionTest', Workspace) " \
...
static shared_ptr<wbx::Reflection::Tuple> yieldResults(shared_ptr<const wbx::Reflection::Tuple> args, wbx::CEvent* event)
{
...
BOOST_FIXTURE_TEST_CASE(YieldFunctions, DataModelFixture)
{
	...
	wbx::Reflection::Tuple args(1);
	args.values[0] = shared_ptr<wbx::Lua::GenericFunction>(new wbx::Lua::GenericFunction(boost::bind(&yieldResults, _1, &event)));
	execute
		(
		"result = ... \n"
		"l = Instance.new('LuaReflectionTest') \n"
...
static shared_ptr<wbx::Reflection::Tuple> yieldResults2(shared_ptr<const wbx::Reflection::Tuple> args, wbx::CEvent* event)
{
...
BOOST_FIXTURE_TEST_CASE(YieldFunctions2, DataModelFixture)
{
	wbx::CEvent event(true);
	wbx::Reflection::Tuple args(1);
	args.values[0] = shared_ptr<wbx::Lua::GenericFunction>(new wbx::Lua::GenericFunction(boost::bind(&yieldResults2, _1, &event)));
	execute
		(
		"result = ... \n"
		"l = Instance.new('LuaReflectionTest') \n"
...
BOOST_FIXTURE_TEST_CASE(PerfAsyncImmediateSuccess, DataModelFixture)
{
	...
	{
		std::auto_ptr<wbx::Reflection::Tuple> result = execute("return true, l:AsyncImmediateDivide(1, 2)");
		check_pcall_aux(result.get(), 1, 2, shared_ptr<CEvent>());
	}
};
...
{
	std::auto_ptr<wbx::Reflection::Tuple> result;
...
{
	wbx::Reflection::Tuple args(1);
	args.values[0] = shared_ptr<wbx::Lua::GenericFunction>(new wbx::Lua::GenericFunction(&check_Event));
...
{
	std::auto_ptr<wbx::Reflection::Tuple> result = execute("return Instance.new('LuaReflectionTest', workspace)\n");
	...
	shared_ptr<wbx::Script> script = Creatable<Instance>::create<Script>();
...
static void checkForMissingType(const wbx::Reflection::Type* type, const wbx::Reflection::ValueArray& args)
{
	using namespace WBX;
	...
	if (type->isType<wbx::SystemAddress>()) // Not scriptable
		return;

	if (type->isType<wbx::Surface>()) // Not scriptable
		return;
	...
	for (wbx::Reflection::ValueArray::const_iterator iter = args.begin(); iter != args.end(); ++iter)
	{
		if (&iter->type() == type)
			return;
	}
...
static void checkForMissingTypes(const wbx::Reflection::ValueArray& args)
{
	std::for_each(wbx::Reflection::Type::getAllTypes().begin(), wbx::Reflection::Type::getAllTypes().end(), boost::bind(&checkForMissingType, _1, args));
}

static wbx::Reflection::ValueArray createAllArgs()
{
	using namespace WBX;
	using namespace Reflection;
	...
	args[4] = (float) 2;
	args[5] = (long) 2;
	args[6] = wbx::ProtectedString::fromTestSource("Hi");
	shared_ptr<Instance> instance = Creatable<Instance>::create<LuaReflectionTest>();
	args[7] = instance;
	shared_ptr<Instances> instances = wbx::make_shared<Instances>();
	...
	args[30] = wbx::CellID(false, Vector3(1,2,3), shared_ptr<Instance>());
    args[31] = G3D::Rect2D();
...
static void mapAllArgs(wbx::Reflection::ValueArray& args)
{
	...
	args[10] = wbx::Lua::WeakFunctionRef();
	args[11] = wbx::Lua::WeakFunctionRef();
...
static bool testArgs(DataModelFixture& fixture, size_t i, size_t mx)
{
	...
	wbx::Reflection::ValueArray args = createAllArgs();
	if (i >= args.size())
		return false;

	mx = std::min(args.size(), mx);

	wbx::Reflection::Tuple tuple(mx - i);
	std::copy(args.begin() + i, args.begin() + mx, tuple.values.begin());

	std::auto_ptr<wbx::Reflection::Tuple> result = fixture.execute("return ...", tuple);
...
{
#if 1
	std::auto_ptr<wbx::Reflection::Tuple> result = execute("t = Instance.new('LuaReflectionTest') return t:Variant('hello')");

	BOOST_REQUIRE_EQUAL(result->values.size(), 1);
	BOOST_CHECK_EQUAL(result->values.at(0).convert<std::string>(),"hello");
#else
	std::auto_ptr<wbx::Reflection::Tuple> result = execute("t = Instance.new('LuaReflectionTest') t.Value = 'world' return t:Variant('hello'), t.Value");
...
BOOST_FIXTURE_TEST_CASE(PerfFunctionCallEnum, DataModelFixture)
{
	...
	std::auto_ptr<wbx::Reflection::Tuple> result = scriptContext->executeInNewThread
		(
		wbx::Security::GameScript_, ProtectedString::fromTestSource(
		"l = Instance.new('LuaReflectionTest') \n"
		"l.Parent = workspace \n"
