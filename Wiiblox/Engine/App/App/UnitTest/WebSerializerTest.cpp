...
BOOST_AUTO_TEST_SUITE(WebSerializer)
	...
	{	
		...
		scoped_ptr<XmlElement> root(wbx::WebSerializer::writeList(*valueCollection));

		Reflection::Variant value;
		BOOST_CHECK(wbx::WebParser::parseWebGenericResponse(root.get(), value));
	...
	{	
		...
		scoped_ptr<XmlElement> root(wbx::WebSerializer::writeTable(*valueMap));
	...
	{	
		...
		scoped_ptr<XmlElement> root(wbx::WebSerializer::writeValue(value));

		Reflection::Variant newValue;
		BOOST_CHECK(wbx::WebParser::parseWebGenericResponse(root.get(), newValue));
