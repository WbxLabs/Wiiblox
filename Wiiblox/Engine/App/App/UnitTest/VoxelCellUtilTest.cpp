...
BOOST_AUTO_TEST_CASE(BlockFaceInfoIsEquivalent) {
	...
	wbx::initBlockOrientationFaceMap();

	// check that struct sizes are same
	BOOST_REQUIRE(sizeof(wbx::BlockFaceInfo) == sizeof(V1Deprecated::BlockFaceInfo));
	BOOST_REQUIRE(sizeof(wbx::BlockAxisFace) == sizeof(V1Deprecated::BlockAxisFace));

	// check that pointers are different
	BOOST_REQUIRE((void*)V1Deprecated::UnOrientedBlockFaceInfos != (void*)wbx::UnOrientedBlockFaceInfos);
	BOOST_REQUIRE((void*)V1Deprecated::OrientedFaceMap != (void*)wbx::OrientedFaceMap);

	// check that pointer contents is the same
	BOOST_REQUIRE(memcmp(V1Deprecated::UnOrientedBlockFaceInfos,
		wbx::UnOrientedBlockFaceInfos, 6 * sizeof(BlockFaceInfo)) == 0);
	BOOST_REQUIRE(memcmp(V1Deprecated::OrientedFaceMap, wbx::OrientedFaceMap,
