...
BOOST_AUTO_TEST_CASE( SettingParentToNullDoesBreakConnection )
{
	...
	wbx::DataModel::LegacyLock lock(&fixture, wbx::DataModelJob::Write);
...
BOOST_AUTO_TEST_CASE( CloneEventAndReceiver )
{
	...
	shared_ptr<Instance> clone(partParent->clone(wbx::ScriptingCreator));
