...
BOOST_AUTO_TEST_CASE(FilterLogService) {
    ...
    testCases.push_back(logTestCase("http", 
                                    "http", 0));
    // two keywords
    testCases.push_back(logTestCase("http://WBXcdn", 
                                    "http://WBXcdn", 0));
    // hash case
    testCases.push_back(logTestCase("http://s3.WBXcdn.com/0123456789ABCDEF0123456789ABCDEF", 
                                    "http://s3.WBXcdn.com/", 4));
    // capitalized
    testCases.push_back(logTestCase("HTTP://S3.WBXCDN.COM/0123456789ABCDEF0123456789ABCDEF", 
                                    "HTTP://S3.WBXCDN.COM/", 4));
    // leading text
    testCases.push_back(logTestCase("failed to reach HTTP://S3.WBXCDN.COM/0123456789ABCDEF0123456789ABCDEF", 
                                    "failed to reach HTTP://S3.WBXCDN.COM/", 4));
    // trailing text
    testCases.push_back(logTestCase("HTTP://S3.WBXCDN.COM/0123456789ABCDEF0123456789ABCDEF request failed",
                                    "HTTP://S3.WBXCDN.COM/ request failed", 4));

    // multiple keys in one log
    testCases.push_back(logTestCase("http://www.Wiiblox.com/h4x.ashx?apikey=1234-1234-1234-1234&evil=true&accesskey=5678-5678", 
                                    "http://www.Wiiblox.com/h4x.ashx?apikey=&evil=true&accesskey=", 0x3));
