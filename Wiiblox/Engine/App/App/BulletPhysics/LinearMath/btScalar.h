...
//			#pragma warning(disable:4786) // Disable the "debug name too long" warning
	...
	#ifdef _MSC_VER
		#include <stdio.h>
		#define btAssert(x) { if(!(x)){printf("Assert %s:%u ("#x")\n", __FILE__, __LINE__);__debugbreak();	}}
	#else//_MSC_VER
		#include <assert.h>
...
#if defined(_MSC_VER) && !defined(BT_NO_SIMD_OPERATOR_OVERLOADS)
...
#endif //defined(_MSC_VER) && !defined(BT_NO_SIMD_OPERATOR_OVERLOADS)
